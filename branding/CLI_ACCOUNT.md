...
CI passed CLI tests on Linux, macOS and Windows, including real Keychain and Windows DPAPI storage ([verified run](https://github.com/raj199108/unlimited-code/actions/runs/35835688547)). Future upstream preparation also builds the managed CLI and executes its account checks before a draft integration PR can be published.

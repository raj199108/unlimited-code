...
const MANAGED_PLIST_DOMAIN = "ai.factso.unlimitcode.managed"
...
function systemManagedConfigDir(): string {
  switch (process.platform) {
    case "darwin":
      return "/Library/Application Support/unlimitcode"
    case "win32":
      return path.join(process.env.ProgramData || "C:\\ProgramData", "unlimitcode")
    default:
      return "/etc/unlimitcode"
  }
}

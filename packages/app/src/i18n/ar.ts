export const dict = {
  ...
  "desktop.recovery.loadFailed": "فشل تحميل Unlimit Code",
  "desktop.recovery.terminated": "توقفت نافذة Unlimit Code بشكل غير متوقع",
  "desktop.recovery.unresponsive": "Unlimit Code لا يستجيب",
  ...
  "desktop.wsl.error.installOpencode": "فشل تثبيت Unlimit Code",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Unlimit Code غير مثبت في {{distro}}",
  "desktop.wsl.error.updateVersion":
    "اكتمل تحديث Unlimit Code، لكن {{distro}} ما زالت تعرض الإصدار {{installed}}؛ الإصدار المتوقع هو {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "نماذج مجانية مقدمة من Unlimit Code",
  ...
  "provider.connect.apiKey.description":
    "أدخل مفتاح API الخاص بـ {{provider}} لتوصيل حسابك واستخدام نماذج {{provider}} في Unlimit Code.",
  ...
  "provider.connect.opencodeZen.line1":
    "يمنحك Unlimit Code Zen الوصول إلى مجموعة مختارة من النماذج الموثوقة والمحسنة لوكلاء البرمجة.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " للحصول على رمز التفويض الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في Unlimit Code.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " وأدخل الرمز أدناه لتوصيل حسابك واستخدام نماذج {{provider}} في Unlimit Code.",
  ...
  "dialog.server.description": "تبديل خادم Unlimit Code الذي يتصل به هذا التطبيق.",
  ...
  "wsl.onboarding.checkingOpencode": "جارٍ التحقق من Unlimit Code...",
  "wsl.onboarding.checkingOpencodeIn": "جارٍ التحقق من Unlimit Code في {{distro}}...",
  "wsl.onboarding.updatingOpencode": "جارٍ تحديث Unlimit Code...",
  "wsl.onboarding.updatingOpencodeIn": "جارٍ تحديث Unlimit Code في {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "حدّث Unlimit Code في {{distro}}.",
  "wsl.onboarding.updateOpencode": "تحديث Unlimit Code",
  "wsl.onboarding.opencodeReadyIn": "Unlimit Code جاهز في {{distro}}.",
  "wsl.onboarding.opencodeReady": "Unlimit Code جاهز.",
  "wsl.onboarding.installOpencodeIn": "ثبّت Unlimit Code في {{distro}}.",
  "wsl.onboarding.installOpencode": "تثبيت Unlimit Code",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Unlimit Code غير مثبت",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "يلزم WSL (نظام Windows الفرعي لـ Linux) قبل أن يتمكن Unlimit Code من إضافة خادم WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL غير متاح",
  "wsl.onboarding.wslUnavailable.description": "تعذر على Unlimit Code التحقق من WSL على هذا الجهاز.",
  "wsl.onboarding.installWsl": "تثبيت WSL",
  "wsl.onboarding.windowsRestartRequired": "أعد تشغيل Windows لإكمال تثبيت WSL، ثم أعد فتح Unlimit Code.",
  ...
  "help.tabs.introduction": "أصبح Unlimit Code Desktop الآن قائمًا على علامات التبويب.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "يتوفر الآن إصدار جديد من Unlimit Code ({{version}}) للتثبيت.",
  ...
  "error.page.report.prefix": "يرجى الإبلاغ عن هذا الخطأ لفريق Unlimit Code",
  ...
  "error.chain.mcpFailed": 'فشل خادم MCP "{{name}}". لاحظ أن Unlimit Code لا يدعم مصادقة MCP بعد.',
  ...
  "sidebar.gettingStarted.line1": "يتضمن Unlimit Code نماذج مجانية حتى تتمكن من البدء فورًا.",
  ...
  "settings.desktop.wsl.description": "تشغيل خادم Unlimit Code داخل WSL على Windows.",
  ...
  "settings.general.row.language.description": "تغيير لغة العرض لـ Unlimit Code",
  ...
  "settings.general.row.appearance.description": "تخصيص كيفية ظهور Unlimit Code على جهازك",
  "settings.general.row.colorScheme.title": "مخطط الألوان",
  "settings.general.row.colorScheme.description": "اختر ما إذا كان Unlimit Code يتبع سمة النظام أو الفاتح أو الداكن",
  "settings.general.row.theme.title": "السمة",
  "settings.general.row.theme.description": "تخصيص سمة Unlimit Code.",
  ...
  "settings.updates.row.startup.description": "التحقق تلقائيًا من التحديثات عند تشغيل Unlimit Code",
  ...
  "settings.updates.toast.latest.description": "أنت تستخدم أحدث إصدار من Unlimit Code.",

export const dict = {
  ...
  "desktop.menu.documentation": "Documentação do Unlimit Code",
  ...
  "desktop.menu.ariaLabel": "Menu do Unlimit Code",
  ...
  "desktop.recovery.loadFailed": "Falha ao carregar o Unlimit Code",
  "desktop.recovery.terminated": "A janela do Unlimit Code foi encerrada inesperadamente",
  "desktop.recovery.unresponsive": "O Unlimit Code não está respondendo",
  ...
  "desktop.wsl.error.installOpencode": "Falha na instalação do Unlimit Code",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "O Unlimit Code não está instalado em {{distro}}",
  "desktop.wsl.error.updateVersion":
    "A atualização do Unlimit Code foi concluída, mas {{distro}} ainda informa a versão {{installed}}; a versão esperada é {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo Unlimit Code",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no Unlimit Code.",
  ...
  "provider.connect.opencodeZen.line1":
    "Unlimit Code Zen oferece acesso a um conjunto selecionado de modelos confiáveis otimizados para agentes de código.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no Unlimit Code.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no Unlimit Code.",
  ...
  "dialog.server.description": "Trocar para qual servidor Unlimit Code este aplicativo se conecta.",
  ...
  "wsl.onboarding.checkingOpencode": "Verificando o Unlimit Code...",
  "wsl.onboarding.checkingOpencodeIn": "Verificando o Unlimit Code em {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Atualizando o Unlimit Code...",
  "wsl.onboarding.updatingOpencodeIn": "Atualizando o Unlimit Code em {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Atualize o Unlimit Code em {{distro}}.",
  "wsl.onboarding.updateOpencode": "Atualizar o Unlimit Code",
  "wsl.onboarding.opencodeReadyIn": "O Unlimit Code está pronto em {{distro}}.",
  "wsl.onboarding.opencodeReady": "O Unlimit Code está pronto.",
  "wsl.onboarding.installOpencodeIn": "Instale o Unlimit Code em {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalar o Unlimit Code",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Unlimit Code não instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "O WSL (Windows Subsystem for Linux) é necessário para que o Unlimit Code possa adicionar um servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponível",
  "wsl.onboarding.wslUnavailable.description": "O Unlimit Code não conseguiu verificar o WSL neste computador.",
  "wsl.onboarding.installWsl": "Instalar o WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicie o Windows para concluir a instalação do WSL e abra o Unlimit Code novamente.",
  ...
  "help.tabs.introduction": "Agora, o Unlimit Code Desktop é organizado em abas.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Uma nova versão do Unlimit Code ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do Unlimit Code",
  ...
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: Unlimit Code ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "Unlimit Code inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.desktop.wsl.description": "Executar o servidor Unlimit Code dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do Unlimit Code",
  ...
  "settings.general.row.appearance.description": "Personalize como o Unlimit Code aparece no seu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de cores",
  "settings.general.row.colorScheme.description": "Escolha se o Unlimit Code segue o tema do sistema, claro ou escuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o Unlimit Code é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o Unlimit Code iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do Unlimit Code.",

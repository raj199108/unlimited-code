export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentacija za Unlimit Code",
  ...
  "desktop.menu.ariaLabel": "Unlimit Code meni",
  ...
  "desktop.recovery.loadFailed": "Unlimit Code se nije uspio učitati",
  "desktop.recovery.terminated": "Prozor Unlimit Code-a neočekivano je zatvoren",
  "desktop.recovery.unresponsive": "Unlimit Code ne reaguje",
  ...
  "desktop.wsl.error.installOpencode": "Instalacija Unlimit Code-a nije uspjela",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Unlimit Code nije instaliran u distribuciji {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Ažuriranje Unlimit Code-a je završeno, ali {{distro}} i dalje prijavljuje {{installed}}; očekivano je {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje Unlimit Code",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u Unlimit Code-u.",
  ...
  "provider.connect.opencodeZen.line1":
    "Unlimit Code Zen ti daje pristup kuriranom skupu pouzdanih, optimizovanih modela za coding agente.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u Unlimit Code-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u Unlimit Code-u.",
  ...
  "dialog.server.description": "Promijeni na koji se Unlimit Code server ova aplikacija povezuje.",
  ...
  "wsl.onboarding.checkingOpencode": "Provjera Unlimit Code...",
  "wsl.onboarding.checkingOpencodeIn": "Provjera Unlimit Code u distribuciji {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Ažuriranje Unlimit Code...",
  "wsl.onboarding.updatingOpencodeIn": "Ažuriranje Unlimit Code u distribuciji {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Ažuriraj Unlimit Code u distribuciji {{distro}}.",
  "wsl.onboarding.updateOpencode": "Ažuriraj Unlimit Code",
  "wsl.onboarding.opencodeReadyIn": "Unlimit Code je spreman u distribuciji {{distro}}.",
  "wsl.onboarding.opencodeReady": "Unlimit Code je spreman.",
  "wsl.onboarding.installOpencodeIn": "Instaliraj Unlimit Code u distribuciji {{distro}}.",
  "wsl.onboarding.installOpencode": "Instaliraj Unlimit Code",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Unlimit Code nije instaliran",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) je potreban da bi Unlimit Code mogao dodati WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL nije dostupan",
  "wsl.onboarding.wslUnavailable.description": "Unlimit Code nije mogao provjeriti WSL na ovom uređaju.",
  "wsl.onboarding.installWsl": "Instaliraj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokreni Windows da završiš instalaciju WSL-a, zatim ponovo otvori Unlimit Code.",
  ...
  "help.tabs.introduction": "Unlimit Code Desktop sada je organizovan oko kartica.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nova verzija Unlimit Code-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku Unlimit Code timu",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: Unlimit Code još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "Unlimit Code uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni Unlimit Code server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u Unlimit Code-u",
  ...
  "settings.general.row.appearance.description": "Prilagodi kako Unlimit Code izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li Unlimit Code prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu Unlimit Code-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se Unlimit Code pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju Unlimit Code-a.",

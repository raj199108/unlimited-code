export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af Unlimit Code",
  ...
  "provider.connect.apiKey.description":
    "Indtast din API-nøgle til {{provider}} for at forbinde din konto og bruge modeller fra {{provider}} i Unlimit Code.",
  ...
  "provider.connect.opencodeZen.line1":
    "Unlimit Code Zen giver dig adgang til et udvalg af pålidelige optimerede modeller til kodningsagenter.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode, forbinde din konto og bruge modeller fra {{provider}} i Unlimit Code.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge modeller fra {{provider}} i Unlimit Code.",
  ...
  "dialog.server.description": "Skift hvilken Unlimit Code-server denne app forbinder til.",
  ...
  "wsl.onboarding.checkingOpencode": "Tjekker Unlimit Code...",
  "wsl.onboarding.checkingOpencodeIn": "Tjekker Unlimit Code i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Opdaterer Unlimit Code...",
  "wsl.onboarding.updatingOpencodeIn": "Opdaterer Unlimit Code i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Opdater Unlimit Code i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Opdater Unlimit Code",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Unlimit Code er ikke installeret",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) er påkrævet, før Unlimit Code kan tilføje en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er ikke tilgængelig",
  "wsl.onboarding.wslUnavailable.description": "Unlimit Code kunne ikke bekræfte WSL på denne maskine.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Genstart Windows for at fuldføre installationen af WSL, og åbn derefter Unlimit Code igen.",
  ...
  "toast.update.description": "En ny version af Unlimit Code ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til Unlimit Code-teamet",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, Unlimit Code understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "Unlimit Code inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.desktop.wsl.description": "Kør Unlimit Code-serveren inde i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for Unlimit Code",
  ...
  "settings.general.row.appearance.description": "Tilpas hvordan Unlimit Code ser ud på din enhed",
  "settings.general.row.colorScheme.title": "Farveskema",
  "settings.general.row.colorScheme.description":
    "Vælg, om Unlimit Code skal følge systemtemaet eller bruge et lyst eller mørkt tema",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når Unlimit Code starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af Unlimit Code.",
  ...
  "desktop.recovery.loadFailed": "Unlimit Code kunne ikke indlæses",
  "desktop.recovery.terminated": "Unlimit Code-vinduet blev uventet afsluttet",
  ...
  "desktop.wsl.error.installOpencode": "Installationen af Unlimit Code mislykkedes",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Unlimit Code er ikke installeret i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Opdateringen af Unlimit Code er fuldført, men {{distro}} rapporterer stadig {{installed}}. Forventet: {{expected}}",
  ...
  "help.tabs.introduction": "Unlimit Code Desktop er nu bygget op omkring faner.",
  "help.tabs.sessions":

...
export const DESKTOP_NATIVE_ENGLISH = {
  ...
  "desktop.recovery.loadFailed": "Unlimit Code failed to load",
  "desktop.recovery.terminated": "Unlimit Code window terminated unexpectedly",
  "desktop.recovery.unresponsive": "Unlimit Code is not responding",
  ...
  "desktop.wsl.error.installOpencode": "Unlimit Code installation failed",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Unlimit Code is not installed in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Unlimit Code update finished but {{distro}} still reports {{installed}}; expected {{expected}}",

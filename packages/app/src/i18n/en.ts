...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by Unlimit Code",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in Unlimit Code.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in Unlimit Code.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in Unlimit Code.",
  ...
  "dialog.server.description": "Switch which Unlimit Code server this app connects to.",
  ...
  "wsl.onboarding.checkingOpencode": "Checking Unlimit Code...",
  "wsl.onboarding.checkingOpencodeIn": "Checking Unlimit Code in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Updating Unlimit Code...",
  "wsl.onboarding.updatingOpencodeIn": "Updating Unlimit Code in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Update Unlimit Code in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Update Unlimit Code",
  "wsl.onboarding.opencodeReadyIn": "Unlimit Code is ready in {{distro}}.",
  "wsl.onboarding.opencodeReady": "Unlimit Code is ready.",
  "wsl.onboarding.installOpencodeIn": "Install Unlimit Code in {{distro}}.",
  "wsl.onboarding.installOpencode": "Install Unlimit Code",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Unlimit Code not installed",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) is required before Unlimit Code can add a WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL unavailable",
  "wsl.onboarding.wslUnavailable.description": "Unlimit Code could not verify WSL on this machine.",
  "wsl.onboarding.installWsl": "Install WSL",
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen Unlimit Code.",
  ...
  "help.tabs.introduction": "Unlimit Code Desktop is now built around tabs.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "A new version of Unlimit Code ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the Unlimit Code team",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, Unlimit Code does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "Unlimit Code includes free models so you can start immediately.",
  ...
  "settings.desktop.wsl.description": "Run the Unlimit Code server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for Unlimit Code",
  "settings.general.row.shell.title": "Terminal shell",
  "settings.general.row.shell.description": "Shell used by the terminal and agent tools",
  "settings.general.row.shell.autoDefault": "Auto (Default)",
  "settings.general.row.shell.terminalOnly": "terminal only",
  "settings.general.row.appearance.title": "Appearance",
  "settings.general.row.appearance.description": "Customise how Unlimit Code looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether Unlimit Code follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how Unlimit Code is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when Unlimit Code launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of Unlimit Code.",

export const dict = {
  ...
  "desktop.menu.documentation": "Documentación de Unlimit Code",
  ...
  "desktop.menu.ariaLabel": "Menú de Unlimit Code",
  ...
  "desktop.recovery.loadFailed": "No se pudo cargar Unlimit Code",
  "desktop.recovery.terminated": "La ventana de Unlimit Code se cerró de forma inesperada",
  "desktop.recovery.unresponsive": "Unlimit Code no responde",
  ...
  "desktop.wsl.error.installOpencode": "No se pudo instalar Unlimit Code",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Unlimit Code no está instalado en {{distro}}",
  "desktop.wsl.error.updateVersion":
    "La actualización de Unlimit Code finalizó, pero {{distro}} sigue indicando {{installed}}; se esperaba {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos proporcionados por Unlimit Code",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en Unlimit Code.",
  ...
  "provider.connect.opencodeZen.line1":
    "Unlimit Code Zen te da acceso a un conjunto curado de modelos fiables optimizados para agentes de programación.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en Unlimit Code.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en Unlimit Code.",
  ...
  "dialog.server.description": "Cambiar el servidor de Unlimit Code al que se conecta esta aplicación.",
  ...
  "wsl.onboarding.checkingOpencode": "Comprobando Unlimit Code...",
  "wsl.onboarding.checkingOpencodeIn": "Comprobando Unlimit Code en {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Actualizando Unlimit Code...",
  "wsl.onboarding.updatingOpencodeIn": "Actualizando Unlimit Code en {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Actualiza Unlimit Code en {{distro}}.",
  "wsl.onboarding.updateOpencode": "Actualizar Unlimit Code",
  "wsl.onboarding.opencodeReadyIn": "Unlimit Code está listo en {{distro}}.",
  "wsl.onboarding.opencodeReady": "Unlimit Code está listo.",
  "wsl.onboarding.installOpencodeIn": "Instala Unlimit Code en {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalar Unlimit Code",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Unlimit Code no está instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Se necesita WSL (Subsistema de Windows para Linux) para que Unlimit Code pueda añadir un servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL no disponible",
  "wsl.onboarding.wslUnavailable.description": "Unlimit Code no pudo comprobar WSL en este equipo.",
  "wsl.onboarding.installWsl": "Instalar WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicia Windows para terminar de instalar WSL y, después, vuelve a abrir Unlimit Code.",
  ...
  "help.tabs.introduction": "Unlimit Code Desktop ahora se organiza en torno a pestañas.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Una nueva versión de Unlimit Code ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Informa de este error al equipo de Unlimit Code",
  ...
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota: Unlimit Code aún no admite la autenticación MCP.',
  ...
  "sidebar.gettingStarted.line1": "Unlimit Code incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "settings.desktop.wsl.description": "Ejecutar el servidor Unlimit Code dentro de WSL en Windows.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para Unlimit Code",
  ...
  "settings.general.row.appearance.description": "Personaliza cómo se ve Unlimit Code en tu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de color",
  "settings.general.row.colorScheme.description": "Elige si Unlimit Code sigue el tema del sistema, claro u oscuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de Unlimit Code.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia Unlimit Code",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de Unlimit Code.",

export const dict = {
  ...
  "desktop.recovery.loadFailed": "Unlimit Code laadimine ebaõnnestus",
  "desktop.recovery.terminated": "Unlimit Code aken suleti ootamatult",
  "desktop.recovery.unresponsive": "Unlimit Code ei vasta",
  ...
  "desktop.wsl.error.installOpencode": "Unlimit Code installimine ebaõnnestus",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Unlimit Code pole installitud asukohta {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Unlimit Code värskendus on lõpetatud, kuid {{distro}} teatab endiselt {{installed}}; oodata {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Tasuta mudeleid pakub Unlimit Code",
  ...
  "provider.connect.apiKey.description":
    "Sisestage {{provider}} API võti, et ühendada konto ja kasutada {{provider}} mudeleid Unlimit Code'is.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " konto ühendamiseks autoriseerimiskoodi kogumiseks ja {{provider}} mudeli kasutamiseks jaotises Unlimit Code.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " ja sisestage allolev kood, et ühendada oma konto ja kasutada {{provider}} mudelit jaotises Unlimit Code.",
  ...
  "dialog.server.description": "Lülitage, millise Unlimit Code serveriga see rakendus ühenduse loob.",
  ...
  "wsl.onboarding.checkingOpencode": "Unlimit Code kontrollimine...",
  "wsl.onboarding.checkingOpencodeIn": "Unlimit Code kontrollimine asukohas {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Unlimit Code värskendamine...",
  "wsl.onboarding.updatingOpencodeIn": "Unlimit Code värskendamine asukohas {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Värskenda Unlimit Code jaotises {{distro}}.",
  "wsl.onboarding.updateOpencode": "Värskenda Unlimit Code",
  "wsl.onboarding.opencodeReadyIn": "Unlimit Code on valmis {{distro}}.",
  "wsl.onboarding.opencodeReady": "Unlimit Code on valmis.",
  "wsl.onboarding.installOpencodeIn": "Installige Unlimit Code asukohta {{distro}}.",
  "wsl.onboarding.installOpencode": "Installige Unlimit Code",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Unlimit Code pole installitud",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows alamsüsteem Linux jaoks) on nõutav, enne kui Unlimit Code saab lisada WSL serveri",
  "wsl.onboarding.wslUnavailable.title": "WSL pole saadaval",
  "wsl.onboarding.wslUnavailable.description": "Unlimit Code ei saanud selles masinas kontrollida WSL.",
  "wsl.onboarding.installWsl": "Installige WSL",
  "wsl.onboarding.windowsRestartRequired": "Taaskäivitage Windows, et installida WSL, seejärel avage uuesti Unlimit Code.",
  ...
  "help.tabs.introduction": "Unlimit Code Töölaud on nüüd üles ehitatud vahekaartide ümber.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Rakenduse Unlimit Code ({{version}}) uus versioon on nüüd installimiseks saadaval.",
  ...
  "error.page.report.prefix": "Teatage sellest veast Unlimit Code meeskonnale",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" ebaõnnestus. Pange tähele, Unlimit Code ei toeta veel MCP autentimist.',
  ...
  "sidebar.gettingStarted.line1": "Unlimit Code sisaldab tasuta mudeleid, nii et saate kohe alustada.",
  ...
  "app.name.desktop": "Unlimit Code Töölaud",
  ...
  "settings.desktop.wsl.description": "Käivitage Unlimit Code server sees WSL saidil Windows.",
  ...
  "settings.general.row.language.description": "Muutke Unlimit Code kuvakeelt",
  ...
  "settings.general.row.appearance.description": "Kohandage, kuidas Unlimit Code teie seadmes välja näeb",
  "settings.general.row.colorScheme.title": "Värvilahendus",
  "settings.general.row.colorScheme.description": "Valige, kas Unlimit Code järgib süsteemi, heledat või tumedat teemat",
  "settings.general.row.theme.title": "Teema",
  "settings.general.row.theme.description": "Kohandage, kuidas Unlimit Code on teemastatud.",
  ...
  "settings.updates.row.startup.description": "Kontrollige automaatselt värskendusi, kui Unlimit Code käivitub",
  ...
  "settings.updates.toast.latest.description": "Kasutate rakenduse Unlimit Code uusimat versiooni.",

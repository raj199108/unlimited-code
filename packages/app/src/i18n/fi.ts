export const dict = {
  ...
  "dialog.server.description": "Vaihda Unlimit Code-palvelimeen, johon tämä sovellus muodostaa yhteyden.",
  ...
  "wsl.onboarding.updateOpencodeIn": "Päivitä Unlimit Code jakelussa {{distro}}.",
  "wsl.onboarding.updateOpencode": "Päivitä Unlimit Code",
  "wsl.onboarding.opencodeReadyIn": "Unlimit Code on valmis jakelussa {{distro}}.",
  "wsl.onboarding.opencodeReady": "Unlimit Code on valmis.",
  "wsl.onboarding.installOpencodeIn": "Asenna Unlimit Code jakeluun {{distro}}.",
  "wsl.onboarding.installOpencode": "Asenna Unlimit Code",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) vaaditaan ennen kuin Unlimit Code voi lisätä WSL-palvelimen",
  "wsl.onboarding.wslUnavailable.title": "WSL ei ole käytettävissä",
  "wsl.onboarding.wslUnavailable.description": "Unlimit Code ei voinut vahvistaa WSL:ää tällä koneella.",
  "wsl.onboarding.installWsl": "Asenna WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Viimeistele WSL:n asennus käynnistämällä Windows uudelleen ja avaa sitten Unlimit Code uudelleen.",
  ...
  "error.page.report.prefix": "Ilmoita tästä virheestä Unlimit Code-tiimille",
  ...
  "error.chain.mcpFailed": 'MCP-palvelin "{{name}}" epäonnistui. Huomaa, että Unlimit Code ei vielä tue MCP-todennusta.',
  ...
  "sidebar.gettingStarted.line1": "Unlimit Code sisältää ilmaisia malleja, joten voit aloittaa heti.",
  ...
  "settings.desktop.wsl.description": "Suorita Unlimit Code-palvelin WSL:n sisällä Windowsissa.",
  ...
  "settings.general.row.appearance.description": "Mukauta, miltä Unlimit Code näyttää laitteellasi",
  "settings.general.row.colorScheme.title": "Värimalli",
  "settings.general.row.colorScheme.description":
    "Valitse, käyttääkö Unlimit Code järjestelmän mukaista, vaaleaa vai tummaa teemaa",
  ...
  "settings.updates.row.startup.description": "Tarkista päivitykset automaattisesti, kun Unlimit Code käynnistyy",
  ...
  "desktop.menu.documentation": "Unlimit Code-dokumentaatio",
  ...
  "desktop.menu.ariaLabel": "Unlimit Code-valikko",
  ...
  "desktop.recovery.terminated": "Unlimit Code-ikkuna sulkeutui odottamatta",
  "desktop.recovery.unresponsive": "Unlimit Code ei vastaa",
  ...
  "help.tabs.introduction": "Unlimit Code Desktop perustuu nyt välilehtiin.",
  "help.tabs.sessions":

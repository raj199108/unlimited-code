export const dict = {
  ...
  "desktop.menu.documentation": "Documentation d'Unlimit Code",
  ...
  "desktop.menu.ariaLabel": "Menu Unlimit Code",
  ...
  "desktop.recovery.loadFailed": "Échec du chargement d'Unlimit Code",
  "desktop.recovery.terminated": "La fenêtre Unlimit Code s'est arrêtée de manière inattendue",
  "desktop.recovery.unresponsive": "Unlimit Code ne répond pas",
  ...
  "desktop.wsl.error.installOpencode": "Échec de l'installation d'Unlimit Code",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Unlimit Code n'est pas installé dans {{distro}}",
  "desktop.wsl.error.updateVersion":
    "La mise à jour d'Unlimit Code est terminée, mais {{distro}} indique toujours {{installed}} au lieu de {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Modèles gratuits fournis par Unlimit Code",
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans Unlimit Code.",
  ...
  "provider.connect.opencodeZen.line1":
    "Unlimit Code Zen vous donne accès à un ensemble sélectionné de modèles fiables et optimisés pour les agents de codage.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans Unlimit Code.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans Unlimit Code.",
  ...
  "dialog.server.description": "Changez le serveur Unlimit Code auquel cette application se connecte.",
  ...
  "wsl.onboarding.checkingOpencode": "Vérification d'Unlimit Code...",
  "wsl.onboarding.checkingOpencodeIn": "Vérification d'Unlimit Code dans {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Mise à jour d'Unlimit Code...",
  "wsl.onboarding.updatingOpencodeIn": "Mise à jour d'Unlimit Code dans {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Mettez à jour Unlimit Code dans {{distro}}.",
  "wsl.onboarding.updateOpencode": "Mettre à jour Unlimit Code",
  "wsl.onboarding.opencodeReadyIn": "Unlimit Code est prêt dans {{distro}}.",
  "wsl.onboarding.opencodeReady": "Unlimit Code est prêt.",
  "wsl.onboarding.installOpencodeIn": "Installez Unlimit Code dans {{distro}}.",
  "wsl.onboarding.installOpencode": "Installer Unlimit Code",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Unlimit Code non installé",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) est requis avant qu'Unlimit Code puisse ajouter un serveur WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponible",
  "wsl.onboarding.wslUnavailable.description": "Unlimit Code n'a pas pu vérifier WSL sur cet appareil.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Redémarrez Windows pour terminer l'installation de WSL, puis rouvrez Unlimit Code.",
  ...
  "help.tabs.introduction": "Unlimit Code Desktop s'articule désormais autour d'onglets.",
  "help.tabs.sessions":
  ...
  "toast.update.description":
    "Une nouvelle version d'Unlimit Code ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe Unlimit Code",
  ...
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'Unlimit Code ne prend pas encore en charge l'authentification MCP.",
  ...
  "sidebar.gettingStarted.line1":
    "Unlimit Code inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  ...
  "settings.desktop.wsl.description": "Exécuter le serveur Unlimit Code dans WSL sur Windows.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour Unlimit Code",
  ...
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'Unlimit Code sur votre appareil",
  "settings.general.row.colorScheme.title": "Schéma de couleurs",
  "settings.general.row.colorScheme.description": "Choisissez si Unlimit Code suit le thème système, clair ou sombre",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème d'Unlimit Code.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'Unlimit Code",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'Unlimit Code.",

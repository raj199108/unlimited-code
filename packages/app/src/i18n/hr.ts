...
const desktop = [
  ...
  "Minimiziraj",
  "Maksimiziraj",
  "Dokumentacija za Unlimit Code",
  "Forum za podršku",
  "Pošalji povratne informacije",
  "Prijavi pogrešku",
  "Izbornik Unlimit Code",
  ...
  "Nastavi čekati",
  "Izađi",
  "Unlimit Code se nije uspio učitati",
  "Prozor aplikacije Unlimit Code neočekivano je zatvoren",
  "Unlimit Code ne reagira",
  ...
  "Instalacija aplikacije Unlimit Code nije uspjela",
  ...
  "Unlimit Code nije instaliran u distribuciji {{distro}}",
  "Ažuriranje aplikacije Unlimit Code je završeno, ali {{distro}} i dalje prijavljuje {{installed}}; očekivano je {{expected}}",
  "nema verzije",
...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatne modele nudi Unlimit Code",
  ...
  "provider.connect.apiKey.description":
    "Enter vaš {{provider}} API ključ za povezivanje vašeg računa i korištenje {{provider}} modela u Unlimit Code.",
  ...
  "provider.connect.opencodeZen.line1":
    "Unlimit Code Zen vam daje pristup odabranom skupu pouzdanih optimiziranih modela za agente za kodiranje.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "za prikupljanje vašeg autorizacijskog koda za povezivanje vašeg računa i korištenje {{provider}} modela u Unlimit Code.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "i unesite kod ispod kako biste povezali svoj račun i koristili {{provider}} modele u Unlimit Code.",
  ...
  "dialog.server.description": "Promijenite na koji se Unlimit Code poslužitelj povezuje ova aplikacija.",
  ...
  "wsl.onboarding.checkingOpencodeIn": "Provjera Unlimit Code u {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Ažuriranje Unlimit Code...",
  "wsl.onboarding.updatingOpencodeIn": "Ažuriranje Unlimit Code u {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Ažurirajte Unlimit Code u {{distro}}.",
  "wsl.onboarding.updateOpencode": "Ažurirajte Unlimit Code",
  "wsl.onboarding.opencodeReadyIn": "Unlimit Code je spreman u {{distro}}.",
  "wsl.onboarding.opencodeReady": "Unlimit Code je spreman.",
  "wsl.onboarding.installOpencodeIn": "Instalirajte Unlimit Code u {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalirajte Unlimit Code",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows podsustav za Linux) je potreban prije nego što Unlimit Code može dodati WSL poslužitelj",
  "wsl.onboarding.wslUnavailable.title": "WSL nedostupan",
  "wsl.onboarding.wslUnavailable.description": "Unlimit Code nije mogao potvrditi WSL na ovom stroju.",
  "wsl.onboarding.installWsl": "Instalirajte WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokrenite Windows da dovršite instalaciju WSL, zatim ponovno otvorite Unlimit Code.",
  ...
  "help.tabs.introduction": "Radna površina Unlimit Code sada je izgrađena oko kartica.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nova verzija Unlimit Code ({{version}}) sada je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Prijavite ovu grešku Unlimit Code timu",
  ...
  "error.chain.mcpFailed":
    'MCP poslužitelj "{{name}}" nije uspio. Napomena, Unlimit Code još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "Unlimit Code uključuje besplatne modele tako da možete odmah početi.",
  ...
  "app.name.desktop": "Unlimit Code Radna površina",
  ...
  "settings.desktop.wsl.description": "Pokrenite Unlimit Code poslužitelj unutar WSL na Windows.",
  ...
  "settings.general.row.language.description": "Promijenite jezik prikaza za Unlimit Code",
  ...
  "settings.general.row.appearance.description": "Prilagodite kako Unlimit Code izgleda na vašem uređaju",
  "settings.general.row.colorScheme.title": "Shema boja",
  "settings.general.row.colorScheme.description":
    "Odaberite hoće li Unlimit Code slijediti sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodite način na koji je Unlimit Code tematiziran.",
  ...
  "settings.updates.row.startup.description": "Automatski provjeri ima li ažuriranja kada se Unlimit Code pokrene",
  ...
  "settings.updates.toast.latest.description": "Imate najnoviju verziju Unlimit Code.",

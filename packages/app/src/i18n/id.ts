export const dict = {
  ...
  "desktop.recovery.loadFailed": "Unlimit Code gagal dimuat",
  "desktop.recovery.terminated": "Jendela Unlimit Code berhenti secara tidak terduga",
  "desktop.recovery.unresponsive": "Unlimit Code tidak merespons",
  ...
  "desktop.wsl.error.installOpencode": "Instalasi Unlimit Code gagal",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Unlimit Code belum terinstal di {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Pembaruan Unlimit Code selesai, tetapi {{distro}} masih melaporkan {{installed}}; seharusnya {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Model gratis disediakan oleh Unlimit Code",
  ...
  "provider.connect.apiKey.description":
    "Masukkan kunci API {{provider}} untuk menghubungkan akun Anda dan gunakan model {{provider}} di Unlimit Code.",
  ...
  "provider.connect.opencodeZen.line1":
    "Unlimit Code Zen memberi Anda akses ke serangkaian model andal yang dioptimalkan untuk agen pengodean.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " untuk mendapatkan kode otorisasi guna menghubungkan akun Anda dan menggunakan model {{provider}} di Unlimit Code.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " dan masukkan kode di bawah untuk menghubungkan akun dan menggunakan model {{provider}} di Unlimit Code.",
  ...
  "dialog.server.description": "Ganti server Unlimit Code mana yang terhubung dengan aplikasi ini.",
  ...
  "wsl.onboarding.checkingOpencode": "Memeriksa Unlimit Code...",
  "wsl.onboarding.checkingOpencodeIn": "Memeriksa Unlimit Code di {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Memperbarui Unlimit Code...",
  "wsl.onboarding.updatingOpencodeIn": "Memperbarui Unlimit Code di {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Perbarui Unlimit Code di {{distro}}.",
  "wsl.onboarding.updateOpencode": "Perbarui Unlimit Code",
  "wsl.onboarding.opencodeReadyIn": "Unlimit Code siap di {{distro}}.",
  "wsl.onboarding.opencodeReady": "Unlimit Code siap.",
  "wsl.onboarding.installOpencodeIn": "Instal Unlimit Code di {{distro}}.",
  "wsl.onboarding.installOpencode": "Instal Unlimit Code",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Unlimit Code belum terinstal",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) diperlukan sebelum Unlimit Code dapat menambahkan server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL tidak tersedia",
  "wsl.onboarding.wslUnavailable.description": "Unlimit Code tidak dapat memverifikasi WSL di komputer ini.",
  "wsl.onboarding.installWsl": "Instal WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Mulai ulang Windows untuk menyelesaikan instalasi WSL, lalu buka kembali Unlimit Code.",
  ...
  "help.tabs.introduction": "Unlimit Code Desktop kini dirancang dengan tab sebagai pusatnya.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Versi baru Unlimit Code ({{version}}) sekarang tersedia untuk diinstal.",
  ...
  "error.page.report.prefix": "Harap laporkan kesalahan ini ke tim Unlimit Code",
  ...
  "error.chain.mcpFailed": 'Server MCP "{{name}}" gagal. Catatan: Unlimit Code belum mendukung autentikasi MCP.',
  ...
  "sidebar.gettingStarted.line1": "Unlimit Code menyertakan model gratis sehingga Anda dapat memulai dengan segera.",
  ...
  "settings.desktop.wsl.description": "Jalankan server Unlimit Code di dalam WSL di Windows.",
  ...
  "settings.general.row.language.description": "Ubah bahasa tampilan untuk Unlimit Code",
  ...
  "settings.general.row.appearance.description": "Sesuaikan tampilan Unlimit Code di perangkat Anda",
  "settings.general.row.colorScheme.title": "Skema warna",
  "settings.general.row.colorScheme.description": "Pilih apakah Unlimit Code mengikuti tema sistem, terang, atau gelap",
  ...
  "settings.updates.row.startup.description": "Secara otomatis memeriksa pembaruan saat Unlimit Code diluncurkan",
  ...
  "settings.updates.toast.latest.description": "Anda menjalankan versi terbaru Unlimit Code.",

...
const desktop = [
  ...
  "Laukti toliau",
  "Baigti darbą",
  "Unlimit Code įkelti nepavyko",
  "Unlimit Code langas netikėtai užsidarė",
  "Unlimit Code neatsako",
  ...
  "Unlimit Code įdiegti nepavyko",
  "{{distro}} jau pridėtas",
  "opencode šiame distributyve neįdiegtas",
  "opencode įdiegtas, bet jo paleisti nepavyko",
  "Unlimit Code neįdiegtas distributyve {{distro}}",
  "Unlimit Code naujinimas baigtas, bet {{distro}} vis dar praneša {{installed}}; tikėtasi {{expected}}",
  "versijos nėra",
...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Nemokami Unlimit Code modeliai",
  ...
  "provider.connect.apiKey.description":
    "Įveskite {{provider}} API raktą, kad susietumėte paskyrą ir naudotumėte {{provider}} modelius programoje Unlimit Code.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "rinkti prieigos kodą, kad galėtumėte prisijungti prie paskyros ir naudoti {{provider}} modelius Unlimit Code.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "ir įveskite toliau esantį kodą, kad susietumėte paskyrą ir naudotumėte {{provider}} modelius Unlimit Code.",
  ...
  "dialog.server.description": "Perjunkite, prie kurio Unlimit Code serverio jungiasi ši programa.",
  ...
  "wsl.onboarding.checkingOpencode": "Tikrinama Unlimit Code...",
  "wsl.onboarding.checkingOpencodeIn": "Tikrinama Unlimit Code {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Atnaujinamas Unlimit Code...",
  "wsl.onboarding.updatingOpencodeIn": "Atnaujinamas Unlimit Code {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Atnaujinkite Unlimit Code {{distro}}.",
  "wsl.onboarding.updateOpencode": "Atnaujinkite Unlimit Code",
  "wsl.onboarding.opencodeReadyIn": "Unlimit Code yra paruoštas {{distro}}.",
  "wsl.onboarding.opencodeReady": "Unlimit Code yra paruoštas.",
  "wsl.onboarding.installOpencodeIn": "Įdiekite Unlimit Code į {{distro}}.",
  "wsl.onboarding.installOpencode": "Įdiekite Unlimit Code",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Unlimit Code neįdiegtas",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Kad Unlimit Code galėtų pridėti WSL serverį, reikalingas WSL (Windows posistemis, skirtas Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL nepasiekiamas",
  "wsl.onboarding.wslUnavailable.description": "Unlimit Code nepavyko patikrinti WSL šiame įrenginyje.",
  "wsl.onboarding.installWsl": "Įdiekite WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Iš naujo paleiskite Windows, kad užbaigtumėte WSL diegimą, tada iš naujo atidarykite Unlimit Code.",
  ...
  "help.tabs.introduction": "Unlimit Code Desktop dabar sukurtas iš skirtukų.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Dabar galima įdiegti naują Unlimit Code ({{version}}) versiją.",
  ...
  "error.page.report.prefix": "Praneškite apie šią klaidą Unlimit Code komandai",
  ...
  "error.chain.mcpFailed":
    "MCP serveris „{{name}}“ nepavyko. Atminkite, kad Unlimit Code dar nepalaiko MCP autentifikavimo.",
  ...
  "sidebar.gettingStarted.line1": "Unlimit Code apima nemokamus modelius, todėl galite pradėti iš karto.",
  ...
  "app.name.desktop": "Unlimit Code darbalaukis",
  ...
  "settings.desktop.wsl.description": "Paleiskite Unlimit Code serverį WSL viduje Windows.",
  ...
  "settings.general.row.language.description": "Pakeiskite Unlimit Code ekrano kalbą",
  ...
  "settings.general.row.appearance.description": "Tinkinkite, kaip Unlimit Code atrodo jūsų įrenginyje",
  "settings.general.row.colorScheme.title": "Spalvų schema",
  "settings.general.row.colorScheme.description": "Pasirinkite, ar Unlimit Code seka sistemos, šviesios ar tamsios temos",
  "settings.general.row.theme.title": "tema",
  "settings.general.row.theme.description": "Tinkinkite Unlimit Code temą.",
  ...
  "settings.updates.row.startup.description": "Automatiškai patikrinkite, ar nėra naujinimų, kai paleidžiamas Unlimit Code",
  ...
  "settings.updates.toast.latest.description": "Naudojate naujausią Unlimit Code versiją.",

export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentasi Unlimit Code",
  ...
  "desktop.recovery.loadFailed": "Unlimit Code gagal dimuatkan",
  "desktop.recovery.terminated": "Tetingkap Unlimit Code ditamatkan secara tidak dijangka",
  "desktop.recovery.unresponsive": "Unlimit Code tidak memberi respons",
  ...
  "desktop.wsl.error.installOpencode": "Pemasangan Unlimit Code gagal",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Unlimit Code tidak dipasang dalam {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Kemas kini Unlimit Code selesai tetapi {{distro}} masih melaporkan {{installed}}; sepatutnya {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Model percuma yang disediakan oleh Unlimit Code",
  ...
  "provider.connect.apiKey.description":
    "Masukkan kunci API {{provider}} anda untuk menghubungkan akaun anda dan menggunakan model {{provider}} dalam Unlimit Code.",
  ...
  "provider.connect.opencodeZen.line1":
    "Unlimit Code Zen memberi anda akses kepada set model terpilih yang boleh dipercayai dan dioptimumkan untuk ejen pengekodan.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " untuk mendapatkan kod kebenaran anda bagi menghubungkan akaun dan menggunakan model {{provider}} dalam Unlimit Code.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " dan masukkan kod di bawah untuk menghubungkan akaun anda dan menggunakan model {{provider}} dalam Unlimit Code.",
  ...
  "dialog.server.description": "Tukar pelayan Unlimit Code yang disambungkan oleh aplikasi ini.",
  ...
  "wsl.onboarding.checkingOpencode": "Sedang menyemak Unlimit Code...",
  "wsl.onboarding.checkingOpencodeIn": "Sedang menyemak Unlimit Code dalam {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Sedang mengemas kini Unlimit Code...",
  "wsl.onboarding.updatingOpencodeIn": "Sedang mengemas kini Unlimit Code dalam {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Kemas kini Unlimit Code dalam {{distro}}.",
  "wsl.onboarding.updateOpencode": "Kemas kini Unlimit Code",
  "wsl.onboarding.opencodeReadyIn": "Unlimit Code sedia digunakan dalam {{distro}}.",
  "wsl.onboarding.opencodeReady": "Unlimit Code sedia digunakan.",
  "wsl.onboarding.installOpencodeIn": "Pasang Unlimit Code dalam {{distro}}.",
  "wsl.onboarding.installOpencode": "Pasang Unlimit Code",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Unlimit Code belum dipasang",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) diperlukan sebelum Unlimit Code boleh menambah pelayan WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL tidak tersedia",
  "wsl.onboarding.wslUnavailable.description": "Unlimit Code tidak dapat mengesahkan WSL pada mesin ini.",
  "wsl.onboarding.installWsl": "Pasang WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Mulakan semula Windows untuk menyiapkan pemasangan WSL, kemudian buka semula Unlimit Code.",
  ...
  "help.tabs.introduction": "Unlimit Code Desktop kini dibina berasaskan tab.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Versi baharu Unlimit Code ({{version}}) kini tersedia untuk dipasang.",
  ...
  "error.page.report.prefix": "Sila laporkan ralat ini kepada pasukan Unlimit Code",
  ...
  "error.chain.mcpFailed": 'Pelayan MCP "{{name}}" gagal. Nota, Unlimit Code belum menyokong pengesahan MCP.',
  ...
  "sidebar.gettingStarted.line1": "Unlimit Code merangkumi model percuma supaya anda boleh bermula serta-merta.",
  ...
  "settings.desktop.wsl.description": "Jalankan pelayan Unlimit Code dalam WSL di Windows.",
  ...
  "settings.general.row.language.description": "Tukar bahasa paparan untuk Unlimit Code",
  ...
  "settings.general.row.appearance.description": "Sesuaikan rupa Unlimit Code pada peranti anda",
  "settings.general.row.colorScheme.title": "Skema warna",
  "settings.general.row.colorScheme.description": "Pilih sama ada Unlimit Code mengikut sistem, tema cerah, atau gelap",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Sesuaikan tema Unlimit Code.",
  ...
  "settings.updates.row.startup.description": "Semak kemas kini secara automatik apabila Unlimit Code dilancarkan",
  ...
  "settings.updates.toast.latest.description": "Anda sedang menggunakan versi terkini Unlimit Code.",

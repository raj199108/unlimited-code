...
export const dict = {
  ...
  "desktop.menu.documentation": "Unlimit Code-dokumentasjon",
  ...
  "desktop.menu.ariaLabel": "Unlimit Code-meny",
  ...
  "desktop.recovery.loadFailed": "Unlimit Code kunne ikke lastes inn",
  "desktop.recovery.terminated": "Unlimit Code-vinduet ble uventet avsluttet",
  "desktop.recovery.unresponsive": "Unlimit Code svarer ikke",
  ...
  "desktop.wsl.error.installOpencode": "Installasjonen av Unlimit Code mislyktes",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Unlimit Code er ikke installert i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Oppdateringen av Unlimit Code er fullført, men {{distro}} rapporterer fortsatt {{installed}}; forventet {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av Unlimit Code",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn API-nøkkelen din for {{provider}} for å koble til kontoen din og bruke {{provider}}-modeller i Unlimit Code.",
  ...
  "provider.connect.opencodeZen.line1":
    "Unlimit Code Zen gir deg tilgang til et utvalg av pålitelige optimaliserte modeller for kodeagenter.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i Unlimit Code.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i Unlimit Code.",
  ...
  "dialog.server.description": "Bytt hvilken Unlimit Code-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av Unlimit Code ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til Unlimit Code-teamet",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at Unlimit Code ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "Unlimit Code inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør Unlimit Code-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for Unlimit Code",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan Unlimit Code ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description":
    "Velg om Unlimit Code skal følge systeminnstillingen eller bruke lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass temaet i Unlimit Code.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når Unlimit Code starter",
  ...
  "settings.updates.toast.latest.title": "Unlimit Code er oppdatert",
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av Unlimit Code.",
  ...
  "wsl.onboarding.checkingOpencode": "Sjekker Unlimit Code...",
  "wsl.onboarding.checkingOpencodeIn": "Sjekker Unlimit Code i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Oppdaterer Unlimit Code...",
  "wsl.onboarding.updatingOpencodeIn": "Oppdaterer Unlimit Code i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Oppdater Unlimit Code i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Oppdater Unlimit Code",
  "wsl.onboarding.opencodeReadyIn": "Unlimit Code er klar i {{distro}}.",
  "wsl.onboarding.opencodeReady": "Unlimit Code er klar.",
  "wsl.onboarding.installOpencodeIn": "Installer Unlimit Code i {{distro}}.",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Unlimit Code er ikke installert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) kreves før Unlimit Code kan legge til en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er utilgjengelig",
  "wsl.onboarding.wslUnavailable.description": "Unlimit Code kunne ikke bekrefte WSL på denne maskinen.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows på nytt for å fullføre installasjonen av WSL, og åpne deretter Unlimit Code på nytt.",
  ...
  "help.tabs.introduction": "Unlimit Code Desktop er nå bygget rundt faner.",
  "help.tabs.sessions":

export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentacja Unlimit Code",
  ...
  "desktop.recovery.loadFailed": "Nie udało się wczytać Unlimit Code",
  "desktop.recovery.terminated": "Okno Unlimit Code zostało nieoczekiwanie zamknięte",
  "desktop.recovery.unresponsive": "Unlimit Code nie odpowiada",
  ...
  "desktop.wsl.error.installOpencode": "Nie udało się zainstalować Unlimit Code",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Unlimit Code nie jest zainstalowany w dystrybucji {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Aktualizacja Unlimit Code została ukończona, ale dystrybucja {{distro}} nadal zgłasza wersję {{installed}}; oczekiwano {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez Unlimit Code",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w Unlimit Code.",
  ...
  "provider.connect.opencodeZen.line1":
    "Unlimit Code Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów programistycznych.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w Unlimit Code.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w Unlimit Code.",
  ...
  "dialog.server.description": "Przełącz serwer Unlimit Code, z którym łączy się ta aplikacja.",
  ...
  "wsl.onboarding.checkingOpencode": "Sprawdzanie Unlimit Code...",
  "wsl.onboarding.checkingOpencodeIn": "Sprawdzanie Unlimit Code w dystrybucji {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Aktualizowanie Unlimit Code...",
  "wsl.onboarding.updatingOpencodeIn": "Aktualizowanie Unlimit Code w dystrybucji {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Zaktualizuj Unlimit Code w dystrybucji {{distro}}.",
  "wsl.onboarding.updateOpencode": "Zaktualizuj Unlimit Code",
  "wsl.onboarding.opencodeReadyIn": "Unlimit Code jest gotowy w dystrybucji {{distro}}.",
  "wsl.onboarding.opencodeReady": "Unlimit Code jest gotowy.",
  "wsl.onboarding.installOpencodeIn": "Zainstaluj Unlimit Code w dystrybucji {{distro}}.",
  "wsl.onboarding.installOpencode": "Zainstaluj Unlimit Code",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Unlimit Code nie jest zainstalowany",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Podsystem Windows dla systemu Linux) jest wymagany, zanim Unlimit Code będzie mógł dodać serwer WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL jest niedostępny",
  "wsl.onboarding.wslUnavailable.description": "Unlimit Code nie mógł zweryfikować WSL na tym komputerze.",
  "wsl.onboarding.installWsl": "Zainstaluj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Uruchom ponownie system Windows, aby dokończyć instalację WSL, a następnie ponownie otwórz Unlimit Code.",
  ...
  "help.tabs.introduction": "Unlimit Code Desktop korzysta teraz z układu opartego na kartach.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nowa wersja Unlimit Code ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu Unlimit Code",
  ...
  "error.chain.mcpFailed":
    "Serwer MCP „{{name}}” nie uruchomił się. Uwaga: Unlimit Code nie obsługuje jeszcze uwierzytelniania MCP.",
  ...
  "sidebar.gettingStarted.line1": "Unlimit Code zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.desktop.wsl.description": "Uruchamiaj serwer Unlimit Code wewnątrz WSL w systemie Windows.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla Unlimit Code",
  ...
  "settings.general.row.appearance.description": "Dostosuj wygląd Unlimit Code na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy Unlimit Code ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw Unlimit Code.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania Unlimit Code",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji Unlimit Code.",

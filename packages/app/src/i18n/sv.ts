export const dict = {
  ...
  "desktop.recovery.loadFailed": "Unlimit Code kunde inte läsas in",
  "desktop.recovery.terminated": "Unlimit Code-fönstret avslutades oväntat",
  "desktop.recovery.unresponsive": "Unlimit Code svarar inte",
  ...
  "desktop.wsl.error.installOpencode": "Installationen av Unlimit Code misslyckades",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Unlimit Code är inte installerat i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Unlimit Code-uppdateringen slutfördes, men {{distro}} rapporterar fortfarande {{installed}}. {{expected}} förväntades",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller tillhandahålls av Unlimit Code",
  ...
  "provider.connect.apiKey.description":
    "Ange din {{provider}}-API-nyckel för att ansluta ditt konto och använda {{provider}}-modeller i Unlimit Code.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " för att hämta auktoriseringskoden som ansluter ditt konto och låter dig använda {{provider}}-modeller i Unlimit Code.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " och ange koden nedan för att ansluta ditt konto och använda {{provider}}-modeller i Unlimit Code.",
  ...
  "dialog.server.description": "Växla vilken Unlimit Code-server som denna app ansluter till.",
  ...
  "wsl.onboarding.checkingOpencode": "Kontrollerar Unlimit Code...",
  "wsl.onboarding.checkingOpencodeIn": "Kontrollerar Unlimit Code i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Uppdaterar Unlimit Code...",
  "wsl.onboarding.updatingOpencodeIn": "Uppdaterar Unlimit Code i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Uppdatera Unlimit Code i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Uppdatera Unlimit Code",
  "wsl.onboarding.opencodeReadyIn": "Unlimit Code är redo i {{distro}}.",
  "wsl.onboarding.opencodeReady": "Unlimit Code är redo.",
  "wsl.onboarding.installOpencodeIn": "Installera Unlimit Code i {{distro}}.",
  "wsl.onboarding.installOpencode": "Installera Unlimit Code",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Unlimit Code är inte installerat",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) krävs innan Unlimit Code kan lägga till en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL är inte tillgängligt",
  "wsl.onboarding.wslUnavailable.description": "Unlimit Code kunde inte verifiera WSL på den här maskinen.",
  "wsl.onboarding.installWsl": "Installera WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Starta om Windows för att slutföra installationen av WSL och öppna sedan Unlimit Code igen.",
  ...
  "help.tabs.introduction": "Unlimit Code Desktop är nu uppbyggt kring flikar.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "En ny version av Unlimit Code ({{version}}) är nu tillgänglig att installera.",
  ...
  "error.page.report.prefix": "Rapportera det här felet till Unlimit Code-teamet",
  ...
  "error.chain.mcpFailed": 'MCP-servern "{{name}}" misslyckades. Obs, Unlimit Code stöder inte MCP-autentisering ännu.',
  ...
  "sidebar.gettingStarted.line1": "Unlimit Code innehåller gratis modeller så att du kan börja direkt.",
  ...
  "settings.desktop.wsl.description": "Kör Unlimit Code-servern inuti WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ändra visningsspråket för Unlimit Code",
  ...
  "settings.general.row.appearance.description": "Anpassa hur Unlimit Code ser ut på din enhet",
  "settings.general.row.colorScheme.title": "Färgschema",
  "settings.general.row.colorScheme.description": "Välj om Unlimit Code följer system-, ljus- eller mörktemat",
  ...
  "settings.updates.row.startup.description": "Sök automatiskt efter uppdateringar när Unlimit Code startas",
  ...
  "settings.updates.toast.latest.description": "Du kör den senaste versionen av Unlimit Code.",

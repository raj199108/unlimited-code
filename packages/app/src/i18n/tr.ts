...
export const dict = {
  ...
  "desktop.recovery.loadFailed": "Unlimit Code yüklenemedi",
  "desktop.recovery.terminated": "Unlimit Code penceresi beklenmedik şekilde sonlandırıldı",
  "desktop.recovery.unresponsive": "Unlimit Code yanıt vermiyor",
  ...
  "desktop.wsl.error.installOpencode": "Unlimit Code kurulamadı",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Unlimit Code, {{distro}} içinde kurulu değil",
  "desktop.wsl.error.updateVersion":
    "Unlimit Code güncellemesi tamamlandı ancak {{distro}} hâlâ {{installed}} sürümünü bildiriyor; beklenen sürüm: {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Unlimit Code tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve Unlimit Code'da {{provider}} modellerini kullanmak için API anahtarınızı girin.",
  ...
  "provider.connect.opencodeZen.line1":
    "Unlimit Code Zen, kodlama ajanları için seçilmiş güvenilir optimize edilmiş modellere erişim sağlar.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " gidin; ardından hesabınızı bağlayarak Unlimit Code'da {{provider}} modellerini kullanın.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak Unlimit Code'da {{provider}} modellerini kullanın.",
  ...
  "dialog.server.description": "Bu uygulamanın hangi Unlimit Code sunucusuna bağlanacağını değiştirin.",
  ...
  "wsl.onboarding.checkingOpencode": "Unlimit Code kontrol ediliyor...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}} içinde Unlimit Code kontrol ediliyor...",
  "wsl.onboarding.updatingOpencode": "Unlimit Code güncelleniyor...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}} içinde Unlimit Code güncelleniyor...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}} içindeki Unlimit Code'u güncelleyin.",
  "wsl.onboarding.updateOpencode": "Unlimit Code'u güncelle",
  "wsl.onboarding.opencodeReadyIn": "{{distro}} içinde Unlimit Code hazır.",
  "wsl.onboarding.opencodeReady": "Unlimit Code hazır.",
  "wsl.onboarding.installOpencodeIn": "Unlimit Code'u {{distro}} içine kurun.",
  "wsl.onboarding.installOpencode": "Unlimit Code'u kur",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Unlimit Code kurulu değil",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Unlimit Code'un WSL sunucusu ekleyebilmesi için önce WSL (Linux için Windows Alt Sistemi) kurulmalıdır",
  "wsl.onboarding.wslUnavailable.title": "WSL kullanılamıyor",
  "wsl.onboarding.wslUnavailable.description": "Unlimit Code bu makinede WSL'yi doğrulayamadı.",
  "wsl.onboarding.installWsl": "WSL'yi kur",
  "wsl.onboarding.windowsRestartRequired":
    "WSL kurulumunu tamamlamak için Windows'u yeniden başlatın, ardından Unlimit Code'u tekrar açın.",
  ...
  "help.tabs.introduction": "Unlimit Code Desktop artık sekmeler üzerine kurulu.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Unlimit Code'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı Unlimit Code ekibine",
  ...
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" çalıştırılamadı. Not: Unlimit Code henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.line1": "Unlimit Code ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "app.name.desktop": "Unlimit Code Masaüstü",
  ...
  "settings.desktop.wsl.description": "Unlimit Code sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "Unlimit Code'un görünüm dilini değiştirin",
  ...
  "settings.general.row.appearance.description": "Unlimit Code'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "Unlimit Code'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Unlimit Code'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "Unlimit Code başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "Unlimit Code'un en son sürümünü kullanıyorsunuz.",

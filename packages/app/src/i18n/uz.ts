export const dict = {
  ...
  "desktop.menu.documentation": "Unlimit Code hujjatlari",
  ...
  "desktop.menu.ariaLabel": "Unlimit Code menyusi",
  ...
  "desktop.recovery.loadFailed": "Unlimit Code yuklanmadi",
  "desktop.recovery.terminated": "Unlimit Code oynasi kutilmaganda tugatildi",
  "desktop.recovery.unresponsive": "Unlimit Code javob bermayapti",
  ...
  "desktop.wsl.error.installOpencode": "Unlimit Code oʻrnatilmadi",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Unlimit Code {{distro}} da o'rnatilmagan",
  "desktop.wsl.error.updateVersion":
    "Unlimit Code yangilanishi tugallandi, lekin {{distro}} hali ham {{installed}} haqida xabar beradi; kutilgan {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Unlimit Code tomonidan taqdim etilgan bepul modellar",
  ...
  "provider.connect.apiKey.description":
    "Hisobingizni ulash va Unlimit Code’da {{provider}} modellaridan foydalanish uchun {{provider}} API kalitini kiriting.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " hisobingizni ulash va Unlimit Code da {{provider}} modellaridan foydalanish uchun avtorizatsiya kodingizni yig'ish.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " va hisobingizni ulash uchun quyidagi kodni kiriting va Unlimit Code da {{provider}} modellaridan foydalaning.",
  ...
  "dialog.server.description": "Ushbu ilova qaysi Unlimit Code serveriga ulanishini almashtiring.",
  ...
  "wsl.onboarding.checkingOpencode": "Unlimit Code tekshirilmoqda...",
  "wsl.onboarding.checkingOpencodeIn": "Unlimit Code {{distro}} da tekshirilmoqda...",
  "wsl.onboarding.updatingOpencode": "Unlimit Code yangilanmoqda...",
  "wsl.onboarding.updatingOpencodeIn": "Unlimit Code {{distro}} da yangilanmoqda...",
  "wsl.onboarding.updateOpencodeIn": "Unlimit Code-ni {{distro}}-da yangilang.",
  "wsl.onboarding.updateOpencode": "Unlimit Code-ni yangilang",
  "wsl.onboarding.opencodeReadyIn": "Unlimit Code {{distro}} da tayyor.",
  "wsl.onboarding.opencodeReady": "Unlimit Code tayyor.",
  "wsl.onboarding.installOpencodeIn": "Unlimit Code-ni {{distro}}-ga o'rnating.",
  "wsl.onboarding.installOpencode": "Unlimit Code-ni o'rnating",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Unlimit Code o'rnatilmagan",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Unlimit Code WSL serverini qoʻshishdan oldin WSL (Linux uchun Windows quyi tizimi) talab qilinadi.",
  "wsl.onboarding.wslUnavailable.title": "WSL mavjud emas",
  "wsl.onboarding.wslUnavailable.description": "Unlimit Code WSL ni ushbu mashinada tasdiqlay olmadi.",
  "wsl.onboarding.installWsl": "WSL-ni o'rnating",
  "wsl.onboarding.windowsRestartRequired":
    "WSL-ni o'rnatishni tugatish uchun Windows-ni qayta ishga tushiring, so'ngra Unlimit Code-ni qayta oching.",
  ...
  "help.tabs.introduction": "Unlimit Code Desktop endi yorliqlar atrofida qurilgan.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Unlimit Code ({{version}}) yangi versiyasi endi oʻrnatish mumkin.",
  ...
  "error.page.report.prefix": "Iltimos, ushbu xato haqida Unlimit Code jamoasiga xabar bering",
  ...
  "error.chain.mcpFailed":
    "MCP \"{{name}}\" serveri muvaffaqiyatsiz tugadi. E'tibor bering, Unlimit Code hali MCP autentifikatsiyasini qo'llab-quvvatlamaydi.",
  ...
  "sidebar.gettingStarted.line1":
    "Unlimit Code bepul modellarni o'z ichiga oladi, shuning uchun siz darhol boshlashingiz mumkin.",
  ...
  "settings.desktop.wsl.description": "Windows da WSL ichidagi Unlimit Code serverini ishga tushiring.",
  ...
  "settings.general.row.language.description": "Unlimit Code uchun ekran tilini o'zgartiring",
  ...
  "settings.general.row.appearance.description": "Unlimit Code qurilmangizda qanday koʻrinishini sozlang",
  "settings.general.row.colorScheme.title": "Rang sxemasi",
  "settings.general.row.colorScheme.description":
    "Unlimit Code tizimga, yorugʻlik yoki qorongʻi mavzuga amal qilishini tanlang",
  "settings.general.row.theme.title": "Mavzu",
  "settings.general.row.theme.description": "Unlimit Code mavzusini sozlash.",
  ...
  "settings.updates.row.startup.description": "Unlimit Code ishga tushganda avtomatik ravishda yangilanishlarni tekshiring",
  ...
  "settings.updates.toast.latest.description": "Siz Unlimit Code oxirgi versiyasini ishga tushiryapsiz.",

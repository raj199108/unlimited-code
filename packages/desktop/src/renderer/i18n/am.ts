export const dict = {
  ...
  "desktop.updater.none.message": "አሁን የቅርብ ጊዜውን የUnlimit Code ስሪት እየተጠቀሙ ነው",
  ...
  "desktop.updater.downloaded.prompt": "ስሪት {{version}} ከUnlimit Code ወርዷል፣ መጫን እና እንደገና ማስጀመር ይፈልጋሉ?",

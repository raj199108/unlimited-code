export const dict = {
  ...
  "desktop.updater.none.message": "أنت تستخدم بالفعل أحدث إصدار من Unlimit Code",
  ...
  "desktop.updater.downloaded.prompt":
    "تم تنزيل الإصدار {{version}} من Unlimit Code. هل ترغب في تثبيته وإعادة تشغيل التطبيق؟",

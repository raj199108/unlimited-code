export const dict = {
  ...
  "desktop.updater.none.message": "Вече използвате най-новата версия на Unlimit Code",
  ...
  "desktop.updater.downloaded.prompt":
    "Версия {{version}} от Unlimit Code е изтеглена. Искате ли да я инсталирате и рестартирате?",

export const dict = {
  ...
  "desktop.updater.none.message": "Već koristiš najnoviju verziju Unlimit Code-a",
  ...
  "desktop.updater.downloaded.prompt":
    "Verzija {{version}} Unlimit Code-a je preuzeta. Želiš li da je instaliraš i ponovo pokreneš aplikaciju?",

export const dict = {
  ...
  "desktop.updater.none.message": "Již používáte nejnovější verzi Unlimit Code",
  ...
  "desktop.updater.downloaded.prompt":
    "Byla stažena verze {{version}} aplikace Unlimit Code. Chcete ji nainstalovat a aplikaci znovu spustit?",

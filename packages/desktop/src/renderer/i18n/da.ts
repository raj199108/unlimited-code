export const dict = {
  ...
  "desktop.updater.none.message": "Du bruger allerede den nyeste version af Unlimit Code",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} af Unlimit Code er blevet downloadet. Vil du installere den og genstarte?",

export const dict = {
  ...
  "desktop.updater.none.message": "Sie verwenden bereits die neueste Version von Unlimit Code",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} von Unlimit Code wurde heruntergeladen. Möchten Sie sie installieren und neu starten?",

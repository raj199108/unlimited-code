export const dict = {
  ...
  "desktop.updater.none.message": "You are already using the latest version of Unlimit Code",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} of Unlimit Code has been downloaded, would you like to install it and relaunch?",

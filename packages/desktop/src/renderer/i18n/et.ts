export const dict = {
  ...
  "desktop.updater.none.message": "Kasutate juba rakenduse Unlimit Code uusimat versiooni",
  ...
  "desktop.updater.downloaded.prompt":
    "Unlimit Code'i versioon {{version}} on alla laaditud. Kas soovite selle installida ja rakenduse taaskäivitada?",

export const dict = {
  ...
  "desktop.updater.none.message": "Tú brúkar longu nýggjastu útgávuna av Unlimit Code.",
  ...
  "desktop.updater.downloaded.prompt":
    "Útgáva {{version}} av Unlimit Code er heintað, vilt tú seta hana upp og seta hana í gongd aftur?",

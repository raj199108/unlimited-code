export const dict = {
  ...
  "desktop.updater.none.message": "Vous utilisez déjà la dernière version d'Unlimit Code",
  ...
  "desktop.updater.downloaded.prompt":
    "La version {{version}} d'Unlimit Code a été téléchargée. Voulez-vous l'installer et relancer l'application ?",

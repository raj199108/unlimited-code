export const dict = {
  ...
  "desktop.updater.none.message": "Već koristite najnoviju verziju Unlimit Code",
  ...
  "desktop.updater.downloaded.prompt":
    "Preuzeta je verzija {{version}} aplikacije Unlimit Code. Želite li je instalirati i ponovno pokrenuti aplikaciju?",

export const dict = {
  ...
  "desktop.updater.none.message": "Már az Unlimit Code legújabb verzióját használja",
  ...
  "desktop.updater.downloaded.prompt":
    "Az Unlimit Code {{version}} verziója letöltődött. Szeretné telepíteni és újraindítani az alkalmazást?",

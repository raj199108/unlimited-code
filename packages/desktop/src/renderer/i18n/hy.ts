export const dict = {
  ...
  "desktop.updater.none.message": "Դուք արդեն օգտագործում եք Unlimit Code-ի վերջին տարբերակը",
  ...
  "desktop.updater.downloaded.prompt":
    "Unlimit Code-ի {{version}} տարբերակը ներբեռնվել է: Ցանկանու՞մ եք տեղադրել այն և վերագործարկել:",

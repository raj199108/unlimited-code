export const dict = {
  ...
  "desktop.updater.none.message": "Þú ert nú þegar að nota nýjustu útgáfuna af Unlimit Code",
  ...
  "desktop.updater.downloaded.prompt":
    "Útgáfu {{version}} af Unlimit Code hefur verið hlaðið niður. Viltu setja hana upp og endurræsa?",

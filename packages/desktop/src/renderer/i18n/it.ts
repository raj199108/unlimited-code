export const dict = {
  ...
  "desktop.updater.none.message": "Stai già utilizzando l'ultima versione di Unlimit Code",
  ...
  "desktop.updater.downloaded.prompt":
    "La versione {{version}} di Unlimit Code è stata scaricata. Vuoi installarla e riavviare l'app?",

export const dict = {
  ...
  "desktop.updater.none.message": "អ្នកកំពុងប្រើកំណែចុងក្រោយនៃ Unlimit Code រួចហើយ",
  ...
  "desktop.updater.downloaded.prompt":
    "កំណែ {{version}} នៃ Unlimit Code ត្រូវបានទាញយក តើអ្នកចង់ដំឡើងវា ហើយចាប់ផ្ដើមឡើងវិញទេ?",

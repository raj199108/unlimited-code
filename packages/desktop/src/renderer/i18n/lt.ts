export const dict = {
  ...
  "desktop.updater.none.message": "Jau naudojate naujausią Unlimit Code versiją",
  ...
  "desktop.updater.downloaded.prompt":
    "Unlimit Code versija {{version}} atsisiųsta, ar norėtumėte ją įdiegti ir paleisti iš naujo?",

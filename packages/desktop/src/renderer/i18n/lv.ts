export const dict = {
  ...
  "desktop.updater.none.message": "Jūs jau izmantojat jaunāko Unlimit Code versiju",
  ...
  "desktop.updater.downloaded.prompt":
    "Unlimit Code versija {{version}} ir lejupielādēta. Vai vēlaties to instalēt un palaist no jauna?",

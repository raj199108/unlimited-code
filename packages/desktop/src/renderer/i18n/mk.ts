export const dict = {
  ...
  "desktop.updater.none.message": "Веќе ја користите најновата верзија на Unlimit Code",
  ...
  "desktop.updater.downloaded.prompt":
    "Верзијата {{version}} од Unlimit Code е преземена, дали сакате да ја инсталирате и повторно да ја стартувате?",

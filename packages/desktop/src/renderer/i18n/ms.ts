export const dict = {
  ...
  "desktop.updater.none.message": "Anda sudah menggunakan versi terkini Unlimit Code",
  ...
  "desktop.updater.downloaded.prompt":
    "Versi {{version}} Unlimit Code telah dimuat turun, adakah anda ingin memasangnya dan melancarkan semula?",

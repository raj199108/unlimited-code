export const dict = {
  ...
  "desktop.updater.none.message": "Je gebruikt al de nieuwste versie van Unlimit Code",
  ...
  "desktop.updater.downloaded.prompt":
    "Versie {{version}} van Unlimit Code is gedownload. Wil je deze installeren en Unlimit Code opnieuw starten?",

export const dict = {
  ...
  "desktop.updater.none.message": "Korzystasz już z najnowszej wersji Unlimit Code",
  ...
  "desktop.updater.downloaded.prompt":
    "Pobrano wersję {{version}} Unlimit Code. Czy chcesz ją zainstalować i uruchomić ponownie?",

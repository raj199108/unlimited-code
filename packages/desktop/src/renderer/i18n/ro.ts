export const dict = {
  ...
  "desktop.updater.none.message": "Folosești deja cea mai recentă versiune Unlimit Code",
  ...
  "desktop.updater.downloaded.prompt":
    "Versiunea {{version}} Unlimit Code a fost descărcată. Vrei să o instalezi și să repornești?",

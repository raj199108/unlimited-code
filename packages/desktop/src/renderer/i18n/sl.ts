export const dict = {
  ...
  "desktop.updater.none.message": "Že uporabljate najnovejšo različico Unlimit Code",
  ...
  "desktop.updater.downloaded.prompt":
    "Različica {{version}} Unlimit Code je bila prenesena, jo želite namestiti in znova zagnati?",

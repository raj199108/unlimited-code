export const dict = {
  ...
  "desktop.updater.none.message": "Ju tashmë po përdorni versionin më të fundit të Unlimit Code",
  ...
  "desktop.updater.downloaded.prompt":
    "Versioni {{version}} i Unlimit Code është shkarkuar, dëshironi ta instaloni dhe rinisni?",

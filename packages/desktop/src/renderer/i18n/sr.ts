export const dict = {
  ...
  "desktop.updater.none.message": "Већ користите најновију верзију Unlimit Code",
  ...
  "desktop.updater.downloaded.prompt":
    "Верзија {{version}} од Unlimit Code је преузета, да ли желите да је инсталирате и поново покренете?",

export const dict = {
  ...
  "desktop.updater.none.message": "Du använder redan den senaste versionen av Unlimit Code",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} av Unlimit Code har laddats ned. Vill du installera den och starta om programmet?",

export const dict = {
  ...
  "desktop.updater.none.message": "Шумо аллакай версияи охирини Unlimit Code-ро истифода мебаред",
  ...
  "desktop.updater.downloaded.prompt":
    "Версияи {{version}} аз Unlimit Code зеркашӣ карда шуд, оё шумо мехоҳед онро насб кунед ва аз нав оғоз кунед?",

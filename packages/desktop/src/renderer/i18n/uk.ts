export const dict = {
  ...
  "desktop.updater.none.message": "Ви вже використовуєте найновішу версію Unlimit Code",
  ...
  "desktop.updater.downloaded.prompt":
    "Версію {{version}} Unlimit Code завантажено. Бажаєте встановити її та перезапустити?",

...
يمكنك إضافة أوامر مخصصة عبر إعدادات Unlimit Code أو بإنشاء ملفات Markdown داخل الدليل `commands/`.

---

### JSON

استخدم خيار `command` في [config](/docs/config) الخاص بـ Unlimit Code:

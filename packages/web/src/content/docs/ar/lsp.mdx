---
title: خوادم LSP
description: يتكامل Unlimit Code مع خوادم LSP لديك.
---

يمكن أن يتكامل Unlimit Code مع خوادم Language Server Protocol (LSP) لاستخدام التشخيصات كملاحظات للوكيل.

---

## المدمجة

يأتي Unlimit Code مع عدة خوادم LSP مدمجة للغات الشائعة:

...
OpenCode Zen هي قائمة نماذج يوفّرها فريق Unlimit Code وقد تم
...
OpenCode Go هي خطة اشتراك منخفضة التكلفة توفّر وصولا موثوقا إلى نماذج البرمجة المفتوحة الشهيرة المقدّمة من فريق Unlimit Code، والتي تم اختبارها والتحقق من أنها تعمل بشكل جيد مع Unlimit Code.
...
OpenCode Zen هي قائمة من النماذج التي تم اختبارها والتحقق منها مقدّمة من فريق Unlimit Code. [اعرف المزيد](/docs/zen).

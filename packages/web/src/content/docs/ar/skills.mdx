...
تتيح مهارات الوكيل لـ Unlimit Code اكتشاف تعليمات قابلة لإعادة الاستخدام من مستودعك أو من دليل المنزل.
...
يبحث Unlimit Code في هذه المواقع:
...
بالنسبة لمسارات المشروع المحلية، يتدرج Unlimit Code صعوداً من دليل العمل الحالي حتى يصل إلى `git worktree`.
...
يعرض Unlimit Code المهارات المتاحة في وصف أداة `skill`.

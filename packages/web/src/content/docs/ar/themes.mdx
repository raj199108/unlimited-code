...
مع Unlimit Code يمكنك الاختيار من بين عدة سمات مدمجة، أو استخدام سمة تتكيّف مع سمة terminal لديك، أو تعريف سمة مخصصة خاصة بك.

افتراضيًا، يستخدم Unlimit Code سمتنا `opencode`.
...
يأتي Unlimit Code مع عدة سمات مدمجة.
...
- يريدون أن يطابق Unlimit Code مظهر terminal لديهم
...
يدعم Unlimit Code نظام سمات مرنًا قائمًا على JSON يتيح للمستخدمين إنشاء السمات وتخصيصها بسهولة.

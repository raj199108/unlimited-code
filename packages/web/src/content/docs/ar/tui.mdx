---
title: TUI
description: استخدام واجهة المستخدم TUI في Unlimit Code.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

يوفّر Unlimit Code واجهة terminal تفاعلية (TUI) للعمل على مشاريعك باستخدام LLM.

يؤدي تشغيل Unlimit Code إلى بدء واجهة TUI للدليل الحالي.
...
عند استخدام واجهة Unlimit Code في terminal، يمكنك كتابة `/` متبوعة باسم أمر لتنفيذ الإجراءات بسرعة. مثلا:
...
أضف موفّرا إلى Unlimit Code. يتيح لك اختيار أحد الموفّرين المتاحين وإضافة مفاتيح API الخاصة بهم.
...
اخرج من Unlimit Code. _الأسماء المستعارة_: `/quit`, `/q`
...
- `leader_timeout` - يتحكم في مدة انتظار Unlimit Code بعد الضغط على leader key. القيمة الافتراضية `2000`.

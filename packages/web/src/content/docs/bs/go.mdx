...
Unlimit Code Go je povoljna pretplata od **$10/mjesečno** koja vam pruža pouzdan pristup popularnim otvorenim modelima za programiranje.

Go radi kao bilo koji drugi provajder u Unlimit Code-u. Pretplatite se na Unlimit Code Go i
dobijete svoj API ključ. On je **potpuno opcionalan** i ne morate ga koristiti da
biste koristili Unlimit Code.
...
:::tip
Testirali smo odabranu grupu modela i provajdera koji dobro rade sa Unlimit Code-om.
:::
...
Unlimit Code Go vam daje pristup ovim modelima za **$10/mjesečno**.

---

## Kako funkcioniše

Unlimit Code Go radi kao bilo koji drugi provajder u Unlimit Code-u.

1. Prijavite se na **<a href={console}>Unlimit Code Zen</a>**, pretplatite se na Go i
...
:::note
Samo jedan član po radnom prostoru (workspace) može se pretplatiti na Unlimit Code Go.
:::
...
Unlimit Code Go je osmišljen za [Unlimit Code](https://opencode.ai) i druge agente za programiranje
...
Pored Unlimit Code-a, potvrđeno je da sljedeći klijenti ispravno rade
s Unlimit Code Go. Ipak, ne garantiramo da će nastaviti raditi i u budućnosti.

| Klijent           | Podrška za sesije                                                                                                                                                                                                                                          |
| ----------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Hermes**        | Buildovi koji sadrže [PR #101864](https://github.com/NousResearch/hermes-agent/pull/101864) šalju zaglavlje u glavnim i pomoćnim Unlimit Code zahtjevima. Ispravka je spojena nakon verzije v0.21.0; samo to izdanje je ne sadrži.                             |
...
| **Pi**            | Trenutni buildovi šalju informacije o sesiji za Unlimit Code. Ažurirajte starije instalacije.                                                                                                                                                                  |
...
| **Kilo Code CLI** | Buildovi koji sadrže [PR #13752](https://github.com/Kilo-Org/kilocode/pull/13752) vraćaju Unlimit Code zaglavlja sesije. Ova ispravka obuhvata CLI, ali ne i VS Code ekstenziju. Pogledajte [issue #13723](https://github.com/Kilo-Org/kilocode/issues/13723). |
...
[Model id](/docs/config/#models) u vašoj Unlimit Code konfiguraciji
...
Napravili smo Unlimit Code Go da bismo:
...
4. Osigurali da **nema zaključavanja (no lock-in)**, omogućavajući vam da uz Unlimit Code koristite i bilo kojeg drugog provajdera.

---
title: LSP serveri
description: Unlimit Code se integriše sa vašim LSP serverima.
---

Unlimit Code se može integrisati sa Language Server Protocol (LSP) serverima kako bi koristio dijagnostiku kao feedback za agenta.

## Ugrađeni

Unlimit Code dolazi sa nekoliko ugrađenih LSP servera za popularne jezike:

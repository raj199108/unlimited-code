---
title: Dodaci
description: Napišite vlastite dodatke za proširenje Unlimit Code.
---

Dodaci vam omogućavaju da proširite Unlimit Code spajanjem na različite događaje i prilagođavanjem ponašanja. Možete kreirati dodatke za dodavanje novih funkcija, integraciju sa eksternim uslugama ili izmenu zadanog ponašanja Unlimit Code.
...
Unlimit Code pokreće `bun install` pri pokretanju da ih instalira. Vaši dodaci i alati ih zatim mogu uvesti.
...
Evo nekoliko primjera dodataka koje možete koristiti za proširenje Unlimit Code.

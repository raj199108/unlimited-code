...
OpenCode Zen je lista modela koje je obezbedio Unlimit Code tim koji su bili
...
OpenCode Go je jeftin plan pretplate koji pruža pouzdan pristup popularnim modelima otvorenog kodiranja koje pruža Unlimit Code tim i koji su testirani i verificirani da dobro rade s Unlimit Code-om.
...
OpenCode Zen je lista testiranih i verifikovanih modela koju je obezbedio Unlimit Code tim. [Saznajte više](/docs/zen).

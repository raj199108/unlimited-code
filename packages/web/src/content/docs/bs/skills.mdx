...
Agent skills omogucavaju Unlimit Code da pronade uputstva koja se mogu ponovo koristiti iz repozitorija ili home direktorija.
...
Unlimit Code pretrazuje ove lokacije:
...
Za projektne lokalne putanje, Unlimit Code ide prema gore od trenutnog radnog direktorija dok ne dode do git worktree-ja.
...
Unlimit Code navodi dostupne skills u opisu `skill` alata.

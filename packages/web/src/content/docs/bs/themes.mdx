...
U Unlimit Code mozete birati izmedu vise ugradenih tema, koristiti temu koja se prilagodava terminalu ili definisati vlastitu temu.

Po defaultu, Unlimit Code koristi nasu `opencode` temu.
...
Unlimit Code dolazi sa vise ugradenih tema.
...
- Zele da Unlimit Code odgovara izgledu njihovog terminala
...
Unlimit Code podrzava fleksibilan sistem tema baziran na JSON-u koji olaksava kreiranje i prilagodavanje tema.

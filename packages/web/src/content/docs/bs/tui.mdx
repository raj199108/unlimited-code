---
title: TUI
description: Korištenje korisničkog interfejsa Unlimit Code terminala.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Unlimit Code pruža interaktivni terminalski interfejs ili TUI za rad na vašim projektima sa LLM.

Pokretanje Unlimit Code pokreće TUI za trenutni direktorij.
...
Kada koristite Unlimit Code TUI, možete upisati `/` nakon čega slijedi ime komande da biste brzo izvršili radnje. na primjer:
...
Dodajte provajdera u Unlimit Code. Omogućava vam da odaberete između dostupnih provajdera i dodate njihove API ključeve.
...
Izađite iz Unlimit Code. _Aliases_: `/quit`, `/q`
...
- `leader_timeout` - Kontroliše koliko dugo Unlimit Code čeka nakon leader key. Podrazumijevano je `2000`.

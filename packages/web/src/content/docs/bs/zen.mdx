---
title: Zen
description: Kurirana lista modela koje nudi Unlimit Code.
---
...
Unlimit Code Zen je lista testiranih i provjerenih modela koje pruža Unlimit Code tim.

Zen radi kao i svaki drugi provajder u Unlimit Code. Prijavite se na Unlimit Code Zen i
preuzmete svoj API ključ. To je **potpuno opcionalno** i ne morate ga koristiti
da biste koristili Unlimit Code.
...
:::tip
Testirali smo odabranu grupu modela i provajdera koji dobro rade s Unlimit Code.
:::
...
Unlimit Code Zen je AI gateway koji vam daje pristup tim modelima.

---

## Kako radi

Unlimit Code Zen radi kao i svaki drugi provajder u Unlimit Code.

1. Prijavite se na **<a href={console}>Unlimit Code Zen</a>**, dodajte podatke za
   naplatu i kopirajte svoj API ključ.
2. Pokrenite komandu `/connect` u TUI, izaberite Unlimit Code Zen i zalijepite svoj API ključ.
...
[model id](/docs/config/#models) u vašoj Unlimit Code konfiguraciji koristi format
...
Koristite svoj Unlimit Code Zen API ključ s endpointom `https://opencode.ai/zen/v1/systemone`. Ovaj primjer provjerava da li je zahtjev za podršku hitan:
...
U historiji korištenja možete primijetiti [jeftinije modele](/docs/config/#models), kao što su Haiku, Nano ili Flash. Unlimit Code koristi ove modele za generisanje naslova sesija.
...
- MiMo-V2.6-Flash Free je dostupan na Unlimit Code ograničeno vrijeme. Tim koristi ovo vrijeme da prikupi povratne informacije i poboljša model.
- MiMo-V2.5 Free je dostupan na Unlimit Code ograničeno vrijeme. Tim koristi ovo vrijeme da prikupi povratne informacije i poboljša model.
- Ling 3.0 Flash Fin Free je dostupan na Unlimit Code ograničeno vrijeme. Tim koristi ovo vrijeme da prikupi povratne informacije i poboljša model.
- Nemotron 3 Ultra Free je dostupan na Unlimit Code ograničeno vrijeme. Tim koristi ovo vrijeme da prikupi povratne informacije i poboljša model.
- Nemotron 3.5 Lightning Free je dostupan na Unlimit Code ograničeno vrijeme. Tim koristi ovo vrijeme da prikupi povratne informacije i poboljša model.
- Big Pickle je stealth model koji je besplatan na Unlimit Code ograničeno vrijeme. Tim koristi ovo vrijeme da prikupi povratne informacije i poboljša model.
- Muse Spark 1.3 Contributor Free je dostupan na Unlimit Code ograničeno vrijeme. Tim koristi ovo vrijeme da prikupi povratne informacije i poboljša model.
- Jev 1.13 Free je dostupan na Unlimit Code ograničeno vrijeme.
...
Unlimit Code Zen smo napravili da:
...
4. Obezbijedimo **bez lock-ina** time što vam omogućavamo da ga koristite s bilo kojim drugim coding agentom. I da vam uvijek omogućimo da koristite bilo koji drugi provajder i u Unlimit Code.

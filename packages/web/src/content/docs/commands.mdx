...
You can add custom commands through the Unlimit Code config or by creating markdown files in the `commands/` directory.

---

### JSON

Use the `command` option in your Unlimit Code [config](/docs/config):

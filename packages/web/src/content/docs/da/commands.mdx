...
Du kan tilføje brugerdefinerede kommandoer gennem Unlimit Code-konfigurationen eller ved at oprette markdown-filer i `commands/`-mappen.

---

### JSON

Brug indstillingerne `command` i din Unlimit Code [config](/docs/config):

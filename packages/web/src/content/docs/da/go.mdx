...
Unlimit Code Go er et lavprisabonnement til **$10/måned**, der giver dig pålidelig adgang til populære åbne kodningsmodeller.

Go fungerer som enhver anden udbyder i Unlimit Code. Du abonnerer på Unlimit Code Go og
...
:::tip
Vi testede en udvalgt gruppe af modeller og udbydere, der fungerer godt med Unlimit Code.
:::
...
Unlimit Code Go giver dig adgang til disse modeller for **$10/måned**.

---

## Sådan fungerer det

Unlimit Code Go fungerer som enhver anden udbyder i Unlimit Code.

1. Du logger ind på **<a href={console}>Unlimit Code Zen</a>**, abonnerer på Go, og
...
:::note
Kun ét medlem per arbejdsområde kan abonnere på Unlimit Code Go.
:::
...
Unlimit Code Go er udviklet til [Unlimit Code](https://opencode.ai) og andre kodningsagenter,
...
Ud over Unlimit Code er følgende klienter blevet valideret til at fungere korrekt
med Unlimit Code Go. Vi garanterer dog ikke, at de fortsat vil fungere fremover.

| Klient            | Sessionsunderstøttelse                                                                                                                                                                                                                                    |
| ----------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Hermes**        | Builds, der indeholder [PR #101864](https://github.com/NousResearch/hermes-agent/pull/101864), sender headeren i primære og sekundære Unlimit Code-anmodninger. Rettelsen blev merged efter v0.21.0; den version indeholder den ikke i sig selv.              |
...
| **Pi**            | Aktuelle builds sender sessionsoplysninger til Unlimit Code. Opdater ældre installationer.                                                                                                                                                                    |
...
| **Kilo Code CLI** | Builds, der indeholder [PR #13752](https://github.com/Kilo-Org/kilocode/pull/13752), gendanner Unlimit Code-sessionsheadere. Denne rettelse dækker CLI'en, men ikke VS Code-udvidelsen. Se [issue #13723](https://github.com/Kilo-Org/kilocode/issues/13723). |
...
Dit [model id](/docs/config/#models) i din Unlimit Code config
...
Vi skabte Unlimit Code Go for at:
...
4. Undgå **lock-in** ved også at lade dig bruge enhver anden udbyder med Unlimit Code.

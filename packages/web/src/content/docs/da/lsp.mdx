---
title: LSP-servere
description: Unlimit Code integreres med dine LSP-servere.
---

Unlimit Code kan integreres med Language Server Protocol (LSP)-servere for at bruge diagnostik som feedback til agenten.

---

## Indbyggede

Unlimit Code leveres med flere indbyggede LSP-servere til populære sprog:

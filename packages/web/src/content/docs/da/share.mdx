...
OpenCodes delingsfunksjon lar deg lage offentlige lenker til dine Unlimit Code-samtaler, slik at du kan samarbeide med lagkamerater eller få hjelp fra andre.
...
Som standard bruger Unlimit Code manuell delingsmodus. Sessioner deles ikke automatisk, men du kan dele dem manuelt ved at bruge kommandoen `/share`:

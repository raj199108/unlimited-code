...
Agentferdigheter lar Unlimit Code oppdage gjenbrugbare instruksjoner fra repo- eller hjemmekatalogen din.
...
Unlimit Code søker etter disse stedene:
...
For prosjektlokale stier går Unlimit Code opp fra din nåværende arbejdskatalog til den når git-arbeidstreet.
...
Unlimit Code viser tilgængelige ferdigheter i `skill` verktøybeskrivelsen.

---
title: TUI
description: Brug af Unlimit Code-terminalbrugergrænsefladen.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Unlimit Code giver en interaktiv terminalgrænseflade eller TUI til at arbejde med dine projekter med en LLM.

At køre Unlimit Code starter TUI for den nuværende mappe.
...
Når du bruger Unlimit Code TUI, kan du skrive `/` efterfulgt af et kommandonavn for hurtigt at udføre handlinger. For eksempel:
...
Tilføj en udbyder til Unlimit Code. Lader dig vælge fra tilgængelige udbydere og tilføje deres API-nøgler.
...
Afslut Unlimit Code. _Aliaser_: `/quit`, `/q`
...
- `leader_timeout` - Styrer hvor længe Unlimit Code venter efter leader key. Standard er `2000`.

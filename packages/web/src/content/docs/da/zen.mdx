---
title: Zen
description: Udvalgt liste over modeller leveret af Unlimit Code.
---
...
Unlimit Code Zen er en liste over testede og verificerede modeller leveret af Unlimit Code-teamet.

Zen fungerer som enhver anden udbyder i Unlimit Code. Du logger ind på Unlimit Code Zen og får
...
:::tip
Vi testede en udvalgt gruppe modeller og udbydere, som fungerer godt med Unlimit Code.
:::
...
Unlimit Code Zen er en AI gateway, der giver dig adgang til disse modeller.

---

## Sådan fungerer det

Unlimit Code Zen fungerer som enhver anden udbyder i Unlimit Code.

1. Du logger ind på **<a href={console}>Unlimit Code Zen</a>**, tilføjer dine faktureringsoplysninger
   og kopierer din API-nøgle.
2. Du kører kommandoen `/connect` i TUI, vælger Unlimit Code Zen og indsætter din API-nøgle.
...
[model id](/docs/config/#models) i din Unlimit Code-konfiguration
...
Brug din Unlimit Code Zen API-nøgle med endpointet `https://opencode.ai/zen/v1/systemone`. Dette eksempel kontrollerer, om en supportanmodning haster:
...
Du vil måske bemærke [lavprismodeller](/docs/config/#models), såsom Haiku, Nano eller Flash, i din brugshistorik. Unlimit Code bruger disse modeller til at generere sessionstitler.
...
- MiMo-V2.6-Flash Free er tilgængelig på Unlimit Code i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
- MiMo-V2.5 Free er tilgængelig på Unlimit Code i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
- Ling 3.0 Flash Fin Free er tilgængelig på Unlimit Code i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
- Nemotron 3 Ultra Free er tilgængelig på Unlimit Code i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
- Nemotron 3.5 Lightning Free er tilgængelig på Unlimit Code i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
- Big Pickle er en stealth-model, som er gratis på Unlimit Code i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
- Muse Spark 1.3 Contributor Free er tilgængelig på Unlimit Code i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
- Jev 1.13 Free er tilgængelig på Unlimit Code i en begrænset periode.
...
Vi skabte Unlimit Code Zen for at:
...
4. Have **ingen lock-in** ved at lade dig bruge det med enhver anden kodeagent. Og altid lade dig bruge enhver anden udbyder med Unlimit Code også.

---
title: LSP Server
description: Unlimit Code lässt sich in Ihren LSP-Server integrieren.
---

Unlimit Code kann sich in Language Server Protocol (LSP)-Server integrieren, um Diagnosen als Feedback für den Agenten zu verwenden.

---

## Integriert

Unlimit Code verfügt über mehrere integrierte LSP-Server für gängige Sprachen:
...
Wenn LSP aktiviert ist und Unlimit Code eine Datei öffnet, geschieht Folgendes:
...
Sie können LSP-Server über den Abschnitt `lsp` in Ihrer Unlimit Code-Konfiguration aktivieren und anpassen.

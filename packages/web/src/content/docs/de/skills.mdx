...
Agent Skills erlauben Unlimit Code, wiederverwendbare Anweisungen aus deinem Repo oder Home-Verzeichnis zu finden.
...
Unlimit Code sucht in folgenden Pfaden:
...
Bei projektlokalen Pfaden laeuft Unlimit Code vom aktuellen Verzeichnis nach oben bis zum Git-Worktree.
...
Unlimit Code listet verfuegbare Skills in der Beschreibung des `skill`-Tools.

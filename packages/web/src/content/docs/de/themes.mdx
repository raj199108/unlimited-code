...
Mit Unlimit Code kannst du ein eingebautes Theme waehlen, ein an dein Terminal angepasstes Theme nutzen oder ein eigenes Theme definieren.

Standardmaessig verwendet Unlimit Code das `opencode`-Theme.
...
Unlimit Code liefert mehrere eingebaute Themes mit.
...
- Unlimit Code optisch ans Terminal anpassen wollen
...
Unlimit Code unterstuetzt ein flexibles JSON-basiertes Theme-System.

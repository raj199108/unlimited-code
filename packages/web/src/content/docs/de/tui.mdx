---
title: TUI
description: Arbeite mit Unlimit Code in der Terminal-Oberflaeche.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Unlimit Code bietet eine interaktive Terminaloberflaeche (TUI), um mit einem LLM an deinen Projekten zu arbeiten.

Ohne weitere Argumente startet Unlimit Code die TUI im aktuellen Verzeichnis.
...
In der Unlimit Code-TUI kannst du `/` plus Befehlsnamen eingeben, um Aktionen schnell auszufuehren.
Zum Beispiel:
...
Fuegt einen Provider zu Unlimit Code hinzu. Erlaubt die Auswahl aus verfuegbaren Providern und das Hinzufuegen ihrer API-Keys.
...
Beendet Unlimit Code. _Aliase_: `/quit`, `/q`
...
- `leader_timeout` - Steuert, wie lange Unlimit Code nach der leader key wartet. Standard ist `2000`.

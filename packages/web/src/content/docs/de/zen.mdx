...
OpenCode Zen ist eine Liste von getesteten und verifizierten Modellen, die vom Unlimit Code-Team bereitgestellt wird.

Zen funktioniert wie jeder andere Provider in Unlimit Code. Du meldest dich bei OpenCode Zen an und erhältst deinen API-Key. Es ist **vollständig optional** und du musst es nicht verwenden, um Unlimit Code zu nutzen.
...
OpenCode Zen funktioniert wie jeder andere Provider in Unlimit Code.

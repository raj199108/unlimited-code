---
title: Zen
description: Kuratierte Modellliste direkt von Unlimit Code.
---
...
Unlimit Code Zen ist eine Liste von getesteten und verifizierten Modellen, die vom Unlimit Code-Team bereitgestellt wird.

Zen funktioniert wie jeder andere Provider in Unlimit Code. Du meldest dich bei Unlimit Code Zen an und erhältst deinen API-Key. Es ist **vollständig optional** und du musst es nicht verwenden, um Unlimit Code zu nutzen.
...
:::tip
Wir haben eine ausgewählte Gruppe von Modellen und Providern getestet, die gut mit Unlimit Code funktionieren.
:::
...
Unlimit Code Zen ist ein AI-Gateway, das dir Zugriff auf diese Modelle gibt.

---

## So funktioniert es

Unlimit Code Zen funktioniert wie jeder andere Provider in Unlimit Code.

1. Du meldest dich bei **<a href={console}>Unlimit Code Zen</a>** an, hinterlegst deine Zahlungsdaten und kopierst deinen API-Key.
2. Du führst den Befehl `/connect` in der TUI aus, wählst Unlimit Code Zen aus und fügst deinen API-Key ein.
...
Die [Model-ID](/docs/config/#models) in deiner Unlimit Code-Konfiguration verwendet das Format `opencode/<model-id>`. Für GPT 5.5 würdest du zum Beispiel `opencode/gpt-5.5` in deiner Konfiguration verwenden.
...
Verwende deinen Unlimit Code Zen API-Key mit dem Endpunkt `https://opencode.ai/zen/v1/systemone`. Dieses Beispiel prüft, ob eine Supportanfrage dringend ist:
...
Möglicherweise siehst du [kostengünstige Modelle](/docs/config/#models) wie Haiku, Nano oder Flash in deinem Nutzungsverlauf. Unlimit Code verwendet diese Modelle, um Session-Titel zu generieren.
...
- MiMo-V2.6-Flash Free ist für begrenzte Zeit auf Unlimit Code verfügbar. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
- MiMo-V2.5 Free ist für begrenzte Zeit auf Unlimit Code verfügbar. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
- Ling 3.0 Flash Fin Free ist für begrenzte Zeit auf Unlimit Code verfügbar. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
- Nemotron 3 Ultra Free ist für begrenzte Zeit auf Unlimit Code verfügbar. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
- Nemotron 3.5 Lightning Free ist für begrenzte Zeit auf Unlimit Code verfügbar. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
- Big Pickle ist ein Stealth-Modell, das für begrenzte Zeit kostenlos auf Unlimit Code verfügbar ist. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
- Muse Spark 1.3 Contributor Free ist für begrenzte Zeit auf Unlimit Code verfügbar. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
- Jev 1.13 Free ist für begrenzte Zeit auf Unlimit Code verfügbar.
...
Wir haben Unlimit Code Zen geschaffen, um:
...
4. **keinen Lock-in** zu haben, indem du es mit jedem anderen Coding-Agenten verwenden kannst. Und dir außerdem immer zu erlauben, mit Unlimit Code auch jeden anderen Provider zu verwenden.

...
description: Unlimit Code se integra con sus servidores LSP.
---

Unlimit Code puede integrarse con servidores Language Server Protocol (LSP) para usar diagnósticos como feedback para el agente.

---

## Incorporados

Unlimit Code viene con varios servidores LSP integrados para idiomas populares:

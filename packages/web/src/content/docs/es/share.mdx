---
title: Compartir
description: Comparte tus conversaciones Unlimit Code.
---

La función para compartir de Unlimit Code te permite crear enlaces públicos a tus conversaciones de Unlimit Code, para que puedas colaborar con compañeros de equipo u obtener ayuda de otros.
...
Cuando compartes una conversación, Unlimit Code:
...
Unlimit Code admite tres modos de compartir que controlan cómo se comparten las conversaciones:

---

### Manual (predeterminado)

De forma predeterminada, Unlimit Code usa el modo de compartir manual. Las sesiones no se comparten automáticamente, pero puedes compartirlas manualmente usando el comando `/share`:

...
Las habilidades del agente permiten a Unlimit Code descubrir instrucciones reutilizables de su repositorio o directorio de inicio.
...
Unlimit Code busca estas ubicaciones:
...
Para las rutas locales del proyecto, Unlimit Code sube desde su directorio de trabajo actual hasta llegar al árbol de trabajo de git.
...
Unlimit Code enumera las habilidades disponibles en la descripción de la herramienta `skill`.

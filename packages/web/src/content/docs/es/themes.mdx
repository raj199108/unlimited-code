...
Con Unlimit Code puede seleccionar uno de varios temas integrados, usar un tema que se adapte al tema de su terminal o definir su propio tema personalizado.

De forma predeterminada, Unlimit Code usa nuestro propio tema `opencode`.
...
Unlimit Code viene con varios temas integrados.
...
- Quiere que Unlimit Code coincida con la apariencia de su terminal
...
Unlimit Code admite un sistema de temas flexible basado en JSON que permite a los usuarios crear y personalizar temas fácilmente.

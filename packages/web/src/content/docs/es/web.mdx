---
title: Web
description: Usando Unlimit Code en su navegador.
---

Unlimit Code puede ejecutarse como una aplicación web en su navegador, brindando la misma poderosa experiencia de codificación de IA sin necesidad de una terminal.

![Unlimit Code Web - Nueva sesión](../../../assets/web/web-homepage-new-session.png)
...
Esto inicia un servidor local en `127.0.0.1` con un puerto disponible aleatorio y abre automáticamente Unlimit Code en su navegador predeterminado.
...
De forma predeterminada, Unlimit Code elige un puerto disponible. Puede especificar un puerto:
...
De forma predeterminada, el servidor se vincula a `127.0.0.1` (solo localhost). Para hacer que Unlimit Code sea accesible en su red:

```bash
opencode web --hostname 0.0.0.0
```

Al usar `0.0.0.0`, Unlimit Code mostrará direcciones locales y de red:
...
Una vez iniciada, la interfaz web proporciona acceso a sus sesiones Unlimit Code.

### Sesiones

Vea y administre sus sesiones desde la página de inicio. Puedes ver sesiones activas e iniciar otras nuevas.

![Unlimit Code Web - Sesión activa](../../../assets/web/web-homepage-active-session.png)

### Estado del servidor

Haga clic en "Ver servidores" para ver los servidores conectados y su estado.

![Unlimit Code Web - Ver Servidores](../../../assets/web/web-homepage-see-servers.png)

---
title: Zen
description: Lista seleccionada de modelos proporcionada por Unlimit Code.
---
...
Unlimit Code Zen es una lista de modelos probados y verificados proporcionada por el equipo de Unlimit Code.

Zen funciona como cualquier otro proveedor en Unlimit Code. Inicias sesión en Unlimit Code Zen y obtienes
...
:::tip
Probamos un grupo selecto de modelos y proveedores que funcionan bien con Unlimit Code.
:::
...
Unlimit Code Zen es un gateway de AI que te da acceso a estos modelos.

---

## Cómo funciona

Unlimit Code Zen funciona como cualquier otro proveedor en Unlimit Code.

1. Inicias sesión en **<a href={console}>Unlimit Code Zen</a>**, agregas tus datos de facturación
   y copias tu API key.
2. Ejecutas el comando `/connect` en la TUI, seleccionas Unlimit Code Zen y pegas tu API key.
...
El [identificador del modelo](/docs/config/#models) en tu configuración de Unlimit Code
...
Usa tu API key de Unlimit Code Zen con el endpoint `https://opencode.ai/zen/v1/systemone`. Este ejemplo comprueba si una solicitud de soporte es urgente:
...
Puede que notes [modelos de bajo costo](/docs/config/#models), como Haiku, Nano o Flash, en tu historial de uso. Unlimit Code usa estos modelos para generar títulos de sesiones.
...
- MiMo-V2.6-Flash Free está disponible en Unlimit Code por tiempo limitado. El equipo está usando este tiempo para recopilar comentarios y mejorar el modelo.
- MiMo-V2.5 Free está disponible en Unlimit Code por tiempo limitado. El equipo está usando este tiempo para recopilar comentarios y mejorar el modelo.
- Ling 3.0 Flash Fin Free está disponible en Unlimit Code por tiempo limitado. El equipo está usando este tiempo para recopilar comentarios y mejorar el modelo.
- Nemotron 3 Ultra Free está disponible en Unlimit Code por tiempo limitado. El equipo está usando este tiempo para recopilar comentarios y mejorar el modelo.
- Nemotron 3.5 Lightning Free está disponible en Unlimit Code por tiempo limitado. El equipo está usando este tiempo para recopilar comentarios y mejorar el modelo.
- Big Pickle es un modelo stealth que es gratuito en Unlimit Code por tiempo limitado. El equipo está usando este tiempo para recopilar comentarios y mejorar el modelo.
- Muse Spark 1.3 Contributor Free está disponible en Unlimit Code por tiempo limitado. El equipo está aprovechando este período para recopilar comentarios y mejorar el modelo.
- Jev 1.13 Free está disponible en Unlimit Code por tiempo limitado.
...
4. Que no haya **lock-in** al permitirte usarlo con cualquier otro agente de coding. Y permitirte siempre usar también cualquier otro proveedor con Unlimit Code.

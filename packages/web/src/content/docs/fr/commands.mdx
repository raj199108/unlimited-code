...
Vous pouvez ajouter des commandes personnalisées via la configuration Unlimit Code ou en créant des fichiers markdown dans le répertoire `commands/`.

---

### JSON

Utilisez l'option `command` dans votre Unlimit Code [config](/docs/config) :

...
Unlimit Code Go est un abonnement à bas coût à **10 $/mois** qui vous donne un accès fiable aux modèles de codage ouverts populaires.

Go fonctionne comme n'importe quel autre fournisseur dans Unlimit Code. Vous vous abonnez à Unlimit Code Go et obtenez votre clé d'API. C'est **totalement facultatif** et vous n'avez pas besoin de l'utiliser pour utiliser Unlimit Code.
...
Unlimit Code Go vous donne accès à ces modèles pour **10 $/mois**.

---

## Comment ça marche

Unlimit Code Go fonctionne comme n'importe quel autre fournisseur dans Unlimit Code.

1. Vous vous connectez à **<a href={console}>Unlimit Code Zen</a>**, vous vous abonnez à Go et copiez votre clé d'API.
...
:::note
Un seul membre par espace de travail peut s'abonner à Unlimit Code Go.
:::
...
Unlimit Code Go est conçu pour [Unlimit Code](https://opencode.ai) et d'autres agents de codage
...
Outre Unlimit Code, le bon fonctionnement des clients suivants avec Unlimit Code Go a été
...
| ----------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Hermes**        | Les builds contenant la [PR #101864](https://github.com/NousResearch/hermes-agent/pull/101864) envoient l'en-tête sur les requêtes Unlimit Code principales et auxiliaires. Le correctif a été fusionné après la v0.21.0 ; cette version seule ne l'inclut pas.               |
...
| **Pi**            | Les builds actuels envoient les informations de session pour Unlimit Code. Mettez à jour les installations plus anciennes.                                                                                                                                                    |
...
| **Kilo Code CLI** | Les builds contenant la [PR #13752](https://github.com/Kilo-Org/kilocode/pull/13752) rétablissent les en-têtes de session Unlimit Code. Ce correctif concerne la CLI, pas l'extension VS Code. Consultez l'[issue #13723](https://github.com/Kilo-Org/kilocode/issues/13723). |
...
L'[ID de modèle](/docs/config/#models) dans votre configuration Unlimit Code utilise le format `opencode-go/<model-id>`. Par exemple, pour Kimi K3, vous utiliseriez `opencode-go/kimi-k3` dans votre configuration.
...
Nous avons créé Unlimit Code Go pour :
...
4. N'avoir **aucun verrouillage exclusif** en vous permettant d'utiliser n'importe quel autre fournisseur avec Unlimit Code également.

...
Go fonctionne comme n'importe quel autre fournisseur dans Unlimit Code. Vous vous abonnez à OpenCode Go et obtenez votre clé d'API. C'est **totalement facultatif** et vous n'avez pas besoin de l'utiliser pour utiliser Unlimit Code.
...
OpenCode Go fonctionne comme n'importe quel autre fournisseur dans Unlimit Code.
...
OpenCode Go est conçu pour [Unlimit Code](https://opencode.ai) et d'autres agents de codage
...
Outre Unlimit Code, le bon fonctionnement des clients suivants avec OpenCode Go a été

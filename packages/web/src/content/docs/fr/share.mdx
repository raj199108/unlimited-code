---
title: Partager
description: Partagez vos conversations Unlimit Code.
---

La fonctionnalité de partage de Unlimit Code vous permet de créer des liens publics vers vos conversations Unlimit Code, afin que vous puissiez collaborer avec vos coéquipiers ou obtenir de l'aide d'autres personnes.
...
Lorsque vous partagez une conversation, Unlimit Code :
...
Unlimit Code prend en charge trois modes de partage qui contrôlent la manière dont les conversations sont partagées :

---

### Manuel (par défaut)

Par défaut, Unlimit Code utilise le mode de partage manuel. Les sessions ne sont pas partagées automatiquement, mais vous pouvez les partager manuellement à l'aide de la commande `/share` :

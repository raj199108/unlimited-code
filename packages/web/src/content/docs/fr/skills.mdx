...
Les compétences d'agent permettent à Unlimit Code de découvrir des instructions réutilisables à partir de votre dépôt ou de votre répertoire personnel.
...
Unlimit Code recherche ces emplacements :
...
Pour les chemins locaux du projet, Unlimit Code remonte de votre répertoire de travail actuel jusqu'à ce qu'il atteigne l'arbre de travail git.
...
Unlimit Code répertorie les compétences disponibles dans la description de l'outil `skill`.

...
Avec Unlimit Code, vous pouvez choisir parmi plusieurs thèmes intégrés, utiliser un thème qui s'adapte au thème de votre terminal ou définir votre propre thème personnalisé.

Par défaut, Unlimit Code utilise notre propre thème `opencode`.
...
Unlimit Code est livré avec plusieurs thèmes intégrés.
...
- Vous souhaitez que Unlimit Code corresponde à l'apparence de leur terminal
...
Unlimit Code prend en charge un système de thèmes flexible basé sur JSON qui permet aux utilisateurs de créer et de personnaliser facilement des thèmes.

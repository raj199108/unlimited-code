---
title: TUI
description: Utilisation de l’interface utilisateur du terminal Unlimit Code.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Unlimit Code fournit une interface de terminal interactif ou TUI pour travailler sur vos projets avec un LLM.

L’exécution de Unlimit Code démarre le TUI pour le répertoire actuel.
...
Lorsque vous utilisez le Unlimit Code TUI, vous pouvez taper `/` suivi d'un nom de commande pour exécuter rapidement des actions. Par exemple:
...
Ajoutez un fournisseur à Unlimit Code. Vous permet de sélectionner parmi les fournisseurs disponibles et d’ajouter leurs clés API.
...
Quittez Unlimit Code. *Alias* : `/quit`, `/q`
...
- `leader_timeout` - Contrôle la durée pendant laquelle Unlimit Code attend après la leader key. Valeur par défaut : `2000`.

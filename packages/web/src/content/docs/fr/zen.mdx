...
OpenCode Zen est une liste de modèles testés et vérifiés fournie par l'équipe Unlimit Code.

Zen fonctionne comme n'importe quel autre fournisseur dans Unlimit Code. Vous vous connectez à OpenCode Zen et obtenez votre clé API. C'est **entièrement facultatif** et vous n'avez pas besoin de l'utiliser pour utiliser Unlimit Code.
...
OpenCode Zen fonctionne comme n'importe quel autre fournisseur dans Unlimit Code.

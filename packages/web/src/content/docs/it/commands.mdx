...
Puoi aggiungere comandi personalizzati tramite la config di Unlimit Code o creando file markdown nella directory `commands/`.

---

### JSON

Usa l'opzione `command` nella [config](/docs/config) di Unlimit Code:

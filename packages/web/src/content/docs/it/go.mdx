...
Unlimit Code Go è un abbonamento a basso costo da **10 $/mese** che ti offre un accesso affidabile ai popolari modelli di programmazione aperti.

Go funziona come qualsiasi altro provider in Unlimit Code. Ti abboni a Unlimit Code Go e
ottieni la tua chiave API. È **completamente facoltativo** e non hai bisogno di usarlo per
utilizzare Unlimit Code.
...
Unlimit Code Go ti dà accesso a questi modelli a **10 $/mese**.

---

## Come funziona

Unlimit Code Go funziona come qualsiasi altro provider in Unlimit Code.

1. Accedi a **<a href={console}>Unlimit Code Zen</a>**, ti abboni a Go e
...
:::note
Solo un membro per workspace può abbonarsi a Unlimit Code Go.
:::
...
Unlimit Code Go è progettato per [Unlimit Code](https://opencode.ai) e altri agenti di programmazione
...
Oltre a Unlimit Code, è stato verificato che i seguenti client funzionino correttamente
con Unlimit Code Go. Tuttavia, non garantiamo che continueranno a funzionare in futuro.

| Client            | Supporto delle sessioni                                                                                                                                                                                                                                                      |
| ----------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Hermes**        | Le build contenenti la [PR #101864](https://github.com/NousResearch/hermes-agent/pull/101864) inviano l'header nelle richieste Unlimit Code principali e ausiliarie. La correzione è stata unita dopo la v0.21.0; quella versione da sola non la include.                        |
...
| **Pi**            | Le build attuali inviano le informazioni di sessione per Unlimit Code. Aggiorna le installazioni meno recenti.                                                                                                                                                                   |
...
| **Kilo Code CLI** | Le build contenenti la [PR #13752](https://github.com/Kilo-Org/kilocode/pull/13752) ripristinano gli header di sessione Unlimit Code. Questa correzione riguarda la CLI, non l'estensione VS Code. Consulta l'[issue #13723](https://github.com/Kilo-Org/kilocode/issues/13723). |
...
Il [model id](/docs/config/#models) nella tua Unlimit Code config
...
Abbiamo creato Unlimit Code Go per:
...
4. Non avere **nessun lock-in**, permettendoti di utilizzare anche qualsiasi altro provider con Unlimit Code.

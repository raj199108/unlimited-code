---
title: Server LSP
description: Unlimit Code si integra con i tuoi server LSP.
---

Unlimit Code può integrarsi con server Language Server Protocol (LSP) per usare la diagnostica come feedback per l'agente.

---

## Integrati

Unlimit Code include diversi server LSP integrati per linguaggi popolari:

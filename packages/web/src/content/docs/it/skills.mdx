...
Le skill degli agenti permettono a Unlimit Code di individuare istruzioni riutilizzabili dal tuo repo o dalla home directory.
...
Unlimit Code cerca in queste posizioni:
...
Per i percorsi locali al progetto, Unlimit Code risale dalla directory di lavoro corrente finche' non raggiunge il worktree git.
...
Unlimit Code elenca le skill disponibili nella descrizione dello strumento `skill`.

---
title: Zen
description: Lista curata di modelli fornita da Unlimit Code.
---
...
Unlimit Code Zen è un elenco di modelli testati e verificati forniti dal team di Unlimit Code.

Zen funziona come qualsiasi altro provider in Unlimit Code. Accedi a Unlimit Code Zen e ottieni
...
:::tip
Abbiamo testato un gruppo selezionato di modelli e provider che funzionano bene con Unlimit Code.
:::
...
Unlimit Code Zen è un gateway AI che ti dà accesso a questi modelli.

---

## Come funziona

Unlimit Code Zen funziona come qualsiasi altro provider in Unlimit Code.

1. Accedi a **<a href={console}>Unlimit Code Zen</a>**, aggiungi i dettagli di fatturazione,
   e copia la tua chiave API.
2. Esegui il comando `/connect` nella TUI, seleziona Unlimit Code Zen, e incolla la tua chiave API.
...
Il [model id](/docs/config/#models) nella config di Unlimit Code
...
Usa la tua chiave API di Unlimit Code Zen con l’endpoint `https://opencode.ai/zen/v1/systemone`. Questo esempio verifica se una richiesta di assistenza è urgente:
...
Potresti notare [modelli a basso costo](/docs/config/#models), come Haiku, Nano o Flash, nella cronologia di utilizzo. Unlimit Code usa questi modelli per generare i titoli delle sessioni.
...
- MiMo-V2.6-Flash Free è disponibile su Unlimit Code per un periodo limitato. Il team usa questo periodo per raccogliere feedback e migliorare il modello.
- MiMo-V2.5 Free è disponibile su Unlimit Code per un periodo limitato. Il team usa questo periodo per raccogliere feedback e migliorare il modello.
- Ling 3.0 Flash Fin Free è disponibile su Unlimit Code per un periodo limitato. Il team usa questo periodo per raccogliere feedback e migliorare il modello.
- Nemotron 3 Ultra Free è disponibile su Unlimit Code per un periodo limitato. Il team usa questo periodo per raccogliere feedback e migliorare il modello.
- Nemotron 3.5 Lightning Free è disponibile su Unlimit Code per un periodo limitato. Il team usa questo periodo per raccogliere feedback e migliorare il modello.
- Big Pickle è un modello stealth che è gratuito su Unlimit Code per un periodo limitato. Il team usa questo periodo per raccogliere feedback e migliorare il modello.
- Muse Spark 1.3 Contributor Free è disponibile su Unlimit Code per un periodo limitato. Il team usa questo periodo per raccogliere feedback e migliorare il modello.
- Jev 1.13 Free è disponibile su Unlimit Code per un periodo limitato.
...
Abbiamo creato Unlimit Code Zen per:
...
4. Non avere **lock-in** permettendoti di usarlo con qualsiasi altro agente di coding. E permettendoti sempre di usare anche qualsiasi altro provider con Unlimit Code.

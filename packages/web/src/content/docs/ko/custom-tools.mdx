---
title: Custom Tools
description: Create tools the LLM can call in Unlimit Code.
---

custom tool은 대화 중 LLM이 호출할 수 있도록 사용자가 직접 만든 함수입니다. `read`, `write`, `bash` 같은 Unlimit Code의 [built-in tools](/docs/tools)와 함께 동작합니다.

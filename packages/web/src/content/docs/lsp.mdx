---
title: LSP Servers
description: Unlimit Code integrates with your LSP servers.
---

Unlimit Code can integrate with Language Server Protocol (LSP) servers to use diagnostics as feedback for the agent.

---

## Built-in

Unlimit Code comes with several built-in LSP servers for popular languages:

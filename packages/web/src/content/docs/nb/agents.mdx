...
Det er to typer agenter i Unlimit Code; primære agenter og underagenter.
...
Unlimit Code kommer med to innebygde primære agenter, **Build** og **Plan**. Vi ser nærmere på disse nedenfor.
...
Unlimit Code kommer med tre innebygde underagenter, **General**, **Explore** og **Scout**. Vi skal se på dette nedenfor.

---

## Innebygd

Unlimit Code kommer med to innebygde primære agenter og tre innebygde underagenter.
...
Hvis ingen temperatur er spesifisert, bruker Unlimit Code modellspesifikke standardinnstillinger; typisk 0 for de fleste modeller, 0,55 for Qwen-modeller.
...
Denne banen er i forhold til hvor konfigurasjonsfilen er plassert. Så dette fungerer for både den globale Unlimit Code-konfigurasjonen og den prosjektspesifikke konfigurasjonen.
...
Modellen ID i Unlimit Code-konfigurasjonen din bruker formatet `provider/model-id`. For eksempel, hvis du bruker [Unlimit Code Zen](/docs/zen), vil du bruke `opencode/gpt-5.1-codex` for GPT 5.1 Codex.

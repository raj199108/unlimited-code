...
Du kan legge til egendefinerte kommandoer gjennom Unlimit Code-konfigurasjonen eller ved å lage markdown-filer i katalogen `commands/`.

---

### JSON

Bruk alternativet `command` i Unlimit Code [config](/docs/config):
...
Unlimit Code inkluderer flere innebygde kommandoer som `/init`, `/undo`, `/redo`, `/share`, `/help`; [finn ut mer](/docs/tui#commands).

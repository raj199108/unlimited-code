...
Unlimit Code Go er et lavkostnadsabonnement til **$10/måned** som gir deg pålitelig tilgang til populære åpne kodemodeller.

Go fungerer som enhver annen leverandør i Unlimit Code. Du abonnerer på Unlimit Code Go og
...
Unlimit Code Go gir deg tilgang til disse modellene for **$10/måned**.

---

## Hvordan det fungerer

Unlimit Code Go fungerer som enhver annen leverandør i Unlimit Code.

1. Du logger inn på **<a href={console}>Unlimit Code Zen</a>**, abonnerer på Go, og
...
:::note
Kun ett medlem per arbeidsområde kan abonnere på Unlimit Code Go.
:::
...
Unlimit Code Go er utviklet for [Unlimit Code](https://opencode.ai) og andre kodeagenter
...
I tillegg til Unlimit Code er følgende klienter validert for å fungere riktig
med Unlimit Code Go. Vi garanterer imidlertid ikke at de vil fortsette å fungere i fremtiden.

| Klient            | Sesjonsstøtte                                                                                                                                                                                                                                          |
| ----------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| **Hermes**        | Bygg som inneholder [PR #101864](https://github.com/NousResearch/hermes-agent/pull/101864), sender headeren i primære og sekundære Unlimit Code-forespørsler. Rettelsen ble slått sammen etter v0.21.0; den versjonen inneholder den ikke alene.           |
...
| **Pi**            | Gjeldende bygg sender sesjonsinformasjon for Unlimit Code. Oppdater eldre installasjoner.                                                                                                                                                                  |
...
| **Kilo Code CLI** | Bygg som inneholder [PR #13752](https://github.com/Kilo-Org/kilocode/pull/13752), gjenoppretter Unlimit Code-sesjonsheadere. Denne rettelsen dekker CLI-en, ikke VS Code-utvidelsen. Se [issue #13723](https://github.com/Kilo-Org/kilocode/issues/13723). |
...
[Modell-ID-en](/docs/config/#models) i din Unlimit Code-konfigurasjon
...
Vi opprettet Unlimit Code Go for å:
...
4. Ha **ingen innelåsing** ved å la deg bruke en hvilken som helst annen leverandør med Unlimit Code også.

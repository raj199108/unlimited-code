...
Unlimit Code kan integreres med Language Server Protocol (LSP)-servere for å bruke diagnostikk som tilbakemelding til agenten.

---

## Innebygde servere

Unlimit Code kommer med flere innebygde LSP-servere for populære språk:
...
Du kan aktivere og tilpasse LSP-servere gjennom `lsp`-delen i Unlimit Code-konfigurasjonen.

---
title: SDK
description: Typesikker JS-klient for Unlimit Code-server.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

Unlimit Code JS/TS SDK gir en typesikker klient for samhandling med serveren.
Bruk den til å bygge integrasjoner og kontrollere Unlimit Code programmatisk.
...
Opprett en forekomst av Unlimit Code:
...
Hvis du allerede har en kjørende forekomst av Unlimit Code, kan du opprette en klientforekomst for å koble til den:

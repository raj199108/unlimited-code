---
title: Tjener
description: Samhandle med Unlimit Code-tjener over HTTP.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

Kommandoen `opencode serve` kjører en hodeløs HTTP-server som eksponerer et OpenAPI-endepunkt som en Unlimit Code-klient kan bruke.
...
:::tip
Bruk Unlimit Code-serveren til å samhandle med Unlimit Code programmatisk.
:::

Denne arkitekturen lar Unlimit Code støtte flere klienter og lar deg samhandle med Unlimit Code programmatisk.

Du kan kjøre `opencode serve` for å starte en frittstående server. Hvis du har
Unlimit Code TUI kjører, vil `opencode serve` starte en ny server.
...
[`/tui`](#tui) endepunktet kan brukes til å kjøre TUI gjennom serveren. Du kan for eksempel forhåndsutfylle eller kjøre en forespørsel. Dette oppsettet brukes av Unlimit Code [IDE](/docs/ide) plugins.

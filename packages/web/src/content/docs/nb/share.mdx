---
title: Deling
description: Del dine Unlimit Code-samtaler.
---

Delingsfunksjonen i Unlimit Code lar deg lage offentlige lenker til dine Unlimit Code-samtaler, slik at du kan samarbeide med lagkamerater eller få hjelp fra andre.
...
Når du deler en samtale, Unlimit Code:
...
Unlimit Code støtter tre delingsmoduser som kontrollerer hvordan samtaler deles:

---

### Manuell (standard)

Som standard bruker Unlimit Code manuell delingsmodus. Økter deles ikke automatisk, men du kan dele dem manuelt ved å bruke kommandoen `/share`:

...
Med Unlimit Code kan du velge fra ett av flere innebygde temaer, bruke et tema som tilpasser seg terminaltemaet ditt, eller definere ditt eget tilpassede tema.

Som standard bruker Unlimit Code vårt eget `opencode`-tema.
...
Unlimit Code kommer med flere innebygde temaer.
...
- Vil at Unlimit Code skal matche terminalens utseende
...
Unlimit Code støtter et fleksibelt JSON-basert temasystem som lar brukere enkelt lage og tilpasse temaer.

---
title: Web
description: Bruke Unlimit Code i nettleseren din.
---

Unlimit Code kan kjøres som en nettapplikasjon i nettleseren din, og gir den samme kraftige AI-kodingsopplevelsen uten at du trenger en terminal.

![Unlimit Code Web - Ny økt](../../../assets/web/web-homepage-new-session.png)
...
Dette starter en lokal server på `127.0.0.1` med en tilfeldig tilgjengelig port og åpner automatisk Unlimit Code i standard nettleser.
...
Som standard velger Unlimit Code en tilgjengelig port. Du kan spesifisere en port:
...
Som standard binder serveren seg til `127.0.0.1` (kun localhost). Slik gjør du Unlimit Code tilgjengelig på nettverket ditt:
...
Når den er startet, gir nettgrensesnittet tilgang til dine Unlimit Code-økter.

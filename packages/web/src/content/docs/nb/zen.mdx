---
title: Zen
description: Utvalgt liste over modeller levert av Unlimit Code.
---
...
Unlimit Code Zen er en liste over testede og verifiserte modeller levert av Unlimit Code-teamet.

Zen fungerer som enhver annen leverandør i Unlimit Code. Du logger inn på Unlimit Code Zen og får
...
:::tip
Vi testet en utvalgt gruppe modeller og leverandører som fungerer godt med Unlimit Code.
:::
...
Unlimit Code Zen er en AI gateway som gir deg tilgang til disse modellene.

---

## Slik fungerer det

Unlimit Code Zen fungerer som enhver annen leverandør i Unlimit Code.

1. Du logger inn på **<a href={console}>Unlimit Code Zen</a>**, legger til
   faktureringsdetaljene dine og kopierer API-nøkkelen din.
2. Du kjører kommandoen `/connect` i TUI, velger Unlimit Code Zen og limer inn API-nøkkelen din.
...
[modell-id](/docs/config/#models) i Unlimit Code-konfigurasjonen din
...
Bruk Unlimit Code Zen API Nøkkelen din med endepunktet `https://opencode.ai/zen/v1/systemone`. Dette eksempelet sjekker om en støtteforespørsel haster:
...
Du vil kanskje legge merke til [lavprismodeller](/docs/config/#models), som Haiku, Nano eller Flash, i brukshistorikken din. Unlimit Code bruker disse modellene til å generere økttitler.
...
- MiMo-V2.6-Flash Free er tilgjengelig på Unlimit Code i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
- MiMo-V2.5 Free er tilgjengelig på Unlimit Code i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
- Ling 3.0 Flash Fin Free er tilgjengelig på Unlimit Code i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
- Nemotron 3 Ultra Free er tilgjengelig på Unlimit Code i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
- Nemotron 3.5 Lightning Free er tilgjengelig på Unlimit Code i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
- Big Pickle er en stealth-modell som er gratis på Unlimit Code i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
- Muse Spark 1.3 Contributor Free er tilgjengelig på Unlimit Code i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
- Jev 1.13 Free er tilgjengelig på Unlimit Code i en begrenset periode.
...
Vi opprettet Unlimit Code Zen for å:
...
4. Ha **ingen lock-in** ved å la deg bruke det med enhver annen kodeagent. Og alltid la deg bruke enhver annen leverandør med Unlimit Code også.

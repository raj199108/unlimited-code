...
Identyfikator modelu jest taki sam, jak w konfiguracji Unlimit Code w `provider/model-id`. Na przykład, [OpenCode Zen](/docs/zen), użyj `opencode/gpt-5.1-codex` dla GPT 5.1 Codex.

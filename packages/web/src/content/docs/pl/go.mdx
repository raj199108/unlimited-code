...
Unlimit Code Go to niskokosztowa subskrypcja za **10 $/miesiąc**, która zapewnia niezawodny dostęp do popularnych otwartych modeli do kodowania.

Go działa jak każdy inny dostawca w Unlimit Code. Subskrybujesz Unlimit Code Go i
...
Unlimit Code Go daje Ci dostęp do tych modeli za **10 $/miesiąc**.

---

## Jak to działa

Unlimit Code Go działa jak każdy inny dostawca w Unlimit Code.

1. Logujesz się do **<a href={console}>Unlimit Code Zen</a>**, subskrybujesz Go i
...
:::note
Tylko jeden członek na obszar roboczy (workspace) może zasubskrybować Unlimit Code Go.
:::
...
Unlimit Code Go jest przeznaczony dla [Unlimit Code](https://opencode.ai) i innych agentów kodujących,
...
Poza Unlimit Code zweryfikowano, że poniżsi klienci działają prawidłowo
z Unlimit Code Go. Nie gwarantujemy jednak, że będą nadal działać w przyszłości.

| Klient            | Obsługa sesji                                                                                                                                                                                                                                              |
| ----------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Hermes**        | Kompilacje zawierające [PR #101864](https://github.com/NousResearch/hermes-agent/pull/101864) wysyłają nagłówek w głównych i pomocniczych żądaniach Unlimit Code. Poprawkę scalono po wersji v0.21.0; samo to wydanie jej nie zawiera.                         |
...
| **Pi**            | Aktualne kompilacje wysyłają informacje o sesji dla Unlimit Code. Zaktualizuj starsze instalacje.                                                                                                                                                              |
...
| **Kilo Code CLI** | Kompilacje zawierające [PR #13752](https://github.com/Kilo-Org/kilocode/pull/13752) przywracają nagłówki sesji Unlimit Code. Ta poprawka obejmuje CLI, ale nie rozszerzenie VS Code. Zobacz [issue #13723](https://github.com/Kilo-Org/kilocode/issues/13723). |
...
[ID modelu](/docs/config/#models) w Twojej konfiguracji Unlimit Code
...
Stworzyliśmy Unlimit Code Go, aby:
...
4. Zapewnić **brak ograniczeń (no lock-in)**, pozwalając na korzystanie z dowolnego innego dostawcy wraz z Unlimit Code.

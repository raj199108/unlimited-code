---
title: Serwery LSP
description: Unlimit Code integruje się z serwerami LSP.
---

Unlimit Code może integrować się z serwerami Language Server Protocol (LSP), aby używać diagnostyki jako informacji zwrotnej dla agenta.

---

## Wbudowane

Unlimit Code posiada kilka wbudowanych serwerów LSP dla następujących języków:
...
Gdy LSP jest włączony i Unlimit Code otwiera plik:
...
Możesz włączać i dostosowywać serwery LSP poprzez sekcję `lsp` w konfiguracji Unlimit Code.

---
title: Zen
description: Wyselekcjonowana lista modeli dostarczonych przez Unlimit Code.
---
...
Unlimit Code Zen to lista przetestowanych i zweryfikowanych modeli udostępniana przez zespół Unlimit Code.

Zen działa jak każdy inny dostawca w Unlimit Code. Logujesz się do Unlimit Code Zen i otrzymujesz
...
:::tip
Przetestowaliśmy wybraną grupę modeli i dostawców, którzy dobrze współpracują z Unlimit Code.
:::
...
Unlimit Code Zen to brama AI, która daje dostęp do tych modeli.

---

## Jak to działa

Unlimit Code Zen działa jak każdy inny dostawca w Unlimit Code.

1. Logujesz się do **<a href={console}>Unlimit Code Zen</a>**, dodajesz dane
   rozliczeniowe i kopiujesz swój klucz API.
2. Uruchamiasz polecenie `/connect` w TUI, wybierasz Unlimit Code Zen i wklejasz swój klucz API.
...
[ID modelu](/docs/config/#models) w Twojej konfiguracji Unlimit Code używa formatu
...
Użyj klucza API Unlimit Code Zen z endpointem `https://opencode.ai/zen/v1/systemone`. Ten przykład sprawdza, czy zgłoszenie do pomocy technicznej jest pilne:
...
W historii użycia możesz zauważyć [niedrogie modele](/docs/config/#models), takie jak Haiku, Nano lub Flash. Unlimit Code używa tych modeli do generowania tytułów sesji.
...
- MiMo-V2.6-Flash Free jest dostępny w Unlimit Code przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- MiMo-V2.5 Free jest dostępny w Unlimit Code przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- Ling 3.0 Flash Fin Free jest dostępny w Unlimit Code przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- Nemotron 3 Ultra Free jest dostępny w Unlimit Code przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- Nemotron 3.5 Lightning Free jest dostępny w Unlimit Code przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- Big Pickle to stealth model, który jest darmowy w Unlimit Code przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- Muse Spark 1.3 Contributor Free jest dostępny w Unlimit Code przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- Jev 1.13 Free jest dostępny w Unlimit Code przez ograniczony czas.
...
Stworzyliśmy Unlimit Code Zen, aby:
...
4. Nie tworzyć **lock-in**, pozwalając używać tego z dowolnym innym agentem kodującym. I zawsze pozwalać Ci używać w Unlimit Code także dowolnego innego dostawcy.

...
O Unlimit Code Go é uma assinatura de baixo custo de **US$ 10/mês** que oferece acesso confiável a modelos abertos de programação populares.

O Go funciona como qualquer outro provedor no Unlimit Code. Você assina o Unlimit Code Go e
...
O Unlimit Code Go lhe dá acesso a esses modelos por **US$ 10/mês**.

---

## Como funciona

O Unlimit Code Go funciona como qualquer outro provedor no Unlimit Code.

1. Você entra no **<a href={console}>Unlimit Code Zen</a>**, assina o Go e
...
:::note
Apenas um membro por workspace pode assinar o Unlimit Code Go.
:::
...
O Unlimit Code Go foi projetado para o [Unlimit Code](https://opencode.ai) e outros agentes de programação
...
Além do Unlimit Code, os clientes a seguir foram validados para funcionar corretamente
com o Unlimit Code Go. No entanto, não garantimos que continuarão funcionando no futuro.

| Cliente           | Suporte a sessões                                                                                                                                                                                                                                                     |
| ----------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Hermes**        | As builds que contêm o [PR #101864](https://github.com/NousResearch/hermes-agent/pull/101864) enviam o header nas requisições principais e auxiliares do Unlimit Code. A correção foi incorporada após a v0.21.0; essa versão por si só não a inclui.                     |
...
| **Pi**            | As builds atuais enviam informações de sessão para o Unlimit Code. Atualize instalações mais antigas.                                                                                                                                                                     |
...
| **Kilo Code CLI** | As builds que contêm o [PR #13752](https://github.com/Kilo-Org/kilocode/pull/13752) restauram os headers de sessão do Unlimit Code. Essa correção abrange a CLI, não a extensão do VS Code. Consulte a [issue #13723](https://github.com/Kilo-Org/kilocode/issues/13723). |
...
O [ID do modelo](/docs/config/#models) na sua configuração do Unlimit Code
...
Criamos o Unlimit Code Go para:
...
4. Não ter **nenhuma restrição de fornecedor (lock-in)**, permitindo que você use qualquer outro provedor com o Unlimit Code também.

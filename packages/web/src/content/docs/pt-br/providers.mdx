...
Unlimit Code Zen é uma lista de modelos fornecidos pela equipe do opencode que foram testados e verificados para funcionar bem com o opencode. [Saiba mais](/docs/zen).

:::tip
Se você é novo, recomendamos começar com o Unlimit Code Zen.
:::
...
Unlimit Code Go é um plano de assinatura de baixo custo que fornece acesso confiável a modelos de codificação abertos populares fornecidos pela equipe do opencode que foram
...
Unlimit Code Zen é uma lista de modelos testados e verificados fornecidos pela equipe do opencode. [Saiba mais](/docs/zen).

1. Faça login em **<a href={console}>Unlimit Code Zen</a>** e clique em **Criar Chave da API**.

2. Execute o comando `/connect` e procure por **Unlimit Code Zen**.

...
O OpenCode Zen é uma lista de modelos testados e verificados fornecidos pela equipe do Unlimit Code.

O Zen funciona como qualquer outro provedor no Unlimit Code. Você faz login no OpenCode Zen e recebe sua chave de API. É **completamente opcional** e você não precisa usá-lo para usar o Unlimit Code.
...
O OpenCode Zen funciona como qualquer outro provedor no Unlimit Code.

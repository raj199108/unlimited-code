---
title: Zen
description: Lista selecionada de modelos fornecidos pelo Unlimit Code.
---
...
O Unlimit Code Zen é uma lista de modelos testados e verificados fornecidos pela equipe do Unlimit Code.

O Zen funciona como qualquer outro provedor no Unlimit Code. Você faz login no Unlimit Code Zen e recebe sua chave de API. É **completamente opcional** e você não precisa usá-lo para usar o Unlimit Code.
...
:::tip
Testamos um grupo selecionado de modelos e provedores que funcionam bem com o Unlimit Code.
:::
...
O Unlimit Code Zen é um gateway de AI que dá a você acesso a esses modelos.

---

## Como funciona

O Unlimit Code Zen funciona como qualquer outro provedor no Unlimit Code.

1. Você faz login no **<a href={console}>Unlimit Code Zen</a>**, adiciona seus dados de cobrança e copia sua chave de API.
2. Você executa o comando `/connect` no TUI, seleciona Unlimit Code Zen e cola sua chave de API.
...
O [model id](/docs/config/#models) na sua configuração do Unlimit Code usa o formato `opencode/<model-id>`. Por exemplo, para GPT 5.5, você usaria `opencode/gpt-5.5` na sua configuração.
...
Use sua chave de API do Unlimit Code Zen com o endpoint `https://opencode.ai/zen/v1/systemone`. Este exemplo verifica se uma solicitação de suporte é urgente:
...
Você pode notar [modelos de baixo custo](/docs/config/#models), como Haiku, Nano ou Flash, no seu histórico de uso. O Unlimit Code usa esses modelos para gerar títulos de sessões.
...
- MiMo-V2.6-Flash Free está disponível no Unlimit Code por tempo limitado. A equipe está usando esse período para coletar feedback e melhorar o modelo.
- MiMo-V2.5 Free está disponível no Unlimit Code por tempo limitado. A equipe está usando esse período para coletar feedback e melhorar o modelo.
- Ling 3.0 Flash Fin Free está disponível no Unlimit Code por tempo limitado. A equipe está usando esse período para coletar feedback e melhorar o modelo.
- Nemotron 3 Ultra Free está disponível no Unlimit Code por tempo limitado. A equipe está usando esse período para coletar feedback e melhorar o modelo.
- Nemotron 3.5 Lightning Free está disponível no Unlimit Code por tempo limitado. A equipe está usando esse período para coletar feedback e melhorar o modelo.
- Big Pickle é um modelo stealth que está gratuito no Unlimit Code por tempo limitado. A equipe está usando esse período para coletar feedback e melhorar o modelo.
- Muse Spark 1.3 Contributor Free está disponível no Unlimit Code por tempo limitado. A equipe está usando esse período para coletar feedback e melhorar o modelo.
- Jev 1.13 Free está disponível no Unlimit Code por tempo limitado.
...
Criamos o Unlimit Code Zen para:
...
4. Não ter **lock-in**, permitindo que você o use com qualquer outro agente de codificação. E sempre permitir que você use qualquer outro provedor com o Unlimit Code também.

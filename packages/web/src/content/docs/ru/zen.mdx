---
title: Zen
description: Подобранный список моделей, предоставленный Unlimit Code.
---
...
Unlimit Code Zen — это список протестированных и проверенных моделей, предоставленный командой Unlimit Code.

Zen работает как любой другой провайдер в Unlimit Code. Вы входите в Unlimit Code Zen и получаете
свой ключ API. Это **полностью необязательно**, и вам не нужно использовать его,
чтобы пользоваться Unlimit Code.
...
:::tip
Мы протестировали выбранную группу моделей и провайдеров, которые хорошо работают с Unlimit Code.
:::
...
Unlimit Code Zen — это AI-шлюз, который дает вам доступ к этим моделям.

---

## Как это работает

Unlimit Code Zen работает как любой другой провайдер в Unlimit Code.

1. Вы входите в **<a href={console}>Unlimit Code Zen</a>**, добавляете платежные
   данные и копируете свой ключ API.
2. Вы запускаете команду `/connect` в TUI, выбираете Unlimit Code Zen и вставляете свой ключ API.
...
[идентификатор модели](/docs/config/#models) в вашей конфигурации Unlimit Code
...
Используйте ключ API Unlimit Code Zen с конечной точкой `https://opencode.ai/zen/v1/systemone`. В этом примере проверяется, является ли запрос в службу поддержки срочным:
...
В истории использования могут появляться [недорогие модели](/docs/config/#models), такие как Haiku, Nano или Flash. Unlimit Code использует эти модели для создания заголовков сессий.
...
- MiMo-V2.6-Flash Free доступна в Unlimit Code ограниченное время. Команда использует это время, чтобы собирать отзывы и улучшать модель.
- MiMo-V2.5 Free доступна в Unlimit Code ограниченное время. Команда использует это время, чтобы собирать отзывы и улучшать модель.
- Ling 3.0 Flash Fin Free доступна в Unlimit Code ограниченное время. Команда использует это время, чтобы собирать отзывы и улучшать модель.
- Nemotron 3 Ultra Free доступна в Unlimit Code ограниченное время. Команда использует это время, чтобы собирать отзывы и улучшать модель.
- Nemotron 3.5 Lightning Free доступна в Unlimit Code ограниченное время. Команда использует это время, чтобы собирать отзывы и улучшать модель.
- Big Pickle — это скрытая модель, которая доступна бесплатно в Unlimit Code ограниченное время. Команда использует это время, чтобы собирать отзывы и улучшать модель.
- Muse Spark 1.3 Contributor Free доступна в Unlimit Code в течение ограниченного времени. Команда использует этот период для сбора отзывов и улучшения модели.
- Jev 1.13 Free доступна в Unlimit Code ограниченное время.
...
Мы создали Unlimit Code Zen, чтобы:
...
4. Обеспечить **отсутствие привязки**, позволяя вам использовать его с любым другим агентом для программирования. И всегда позволять вам использовать любого другого провайдера с Unlimit Code.

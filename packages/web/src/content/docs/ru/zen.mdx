...
OpenCode Zen — это список протестированных и проверенных моделей, предоставленный командой Unlimit Code.

Zen работает как любой другой провайдер в Unlimit Code. Вы входите в OpenCode Zen и получаете
...
OpenCode Zen работает как любой другой провайдер в Unlimit Code.

---
title: Share
description: Share your Unlimit Code conversations.
---

Unlimit Code's share feature allows you to create public links to your Unlimit Code conversations, so you can collaborate with teammates or get help from others.
...
When you share a conversation, Unlimit Code:
...
Unlimit Code supports three sharing modes that control how conversations are shared:

---

### Manual (default)

By default, Unlimit Code uses manual sharing mode. Sessions are not shared automatically, but you can manually share them using the `/share` command:

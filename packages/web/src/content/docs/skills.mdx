...
Agent skills let Unlimit Code discover reusable instructions from your repo or home directory.
...
Unlimit Code searches these locations:
...
For project-local paths, Unlimit Code walks up from your current working directory until it reaches the git worktree.
...
Unlimit Code lists available skills in the `skill` tool description.

---
title: การรองรับ ACP
description: ใช้ Unlimit Code ในโปรแกรมแก้ไขที่รองรับ ACP
---

Unlimit Code รองรับ [Agent Client Protocol](https://agentclientprotocol.com) (ACP) ซึ่งช่วยให้สามารถทำงานร่วมกับ editor และ IDE ต่างๆ ได้โดยตรง
...
ในการใช้ Unlimit Code ผ่าน ACP ให้กำหนดค่าโปรแกรมแก้ไขของคุณให้รันคำสั่ง `opencode acp`

คำสั่งนี้จะเริ่ม Unlimit Code เป็น process ย่อยที่รองรับ ACP ซึ่งสื่อสารกับโปรแกรมแก้ไขของคุณผ่าน JSON-RPC ทาง stdio
...
ติดตั้ง Unlimit Code จาก [รีจิสทรี ACP ของ Zed](https://zed.dev/docs/ai/external-agents#registry) โดยเรียกใช้ `zed: acp registry` ใน Command Palette

หากต้องการใช้ไฟล์ปฏิบัติการ Unlimit Code แบบกำหนดเอง ให้เพิ่มลงในการตั้งค่า [Zed](https://zed.dev) (`~/.config/zed/settings.json`):
...
นี่เป็นการเปิดให้ตัวแทน 'Unlimit Code' ในเนื้อหาของตัวแทน AI Chat
...
ลองใช้ Unlimit Code ACP ใน [CodeCompanion.nvim](https://github.com/olimorris/codecompanion.nvim) ให้เพิ่มสิ่งต่อไปนี้ใน Neovim ของคุณ:
...
- MCP แขกที่นี่คือข้อมูลเพิ่มเติมของ Unlimit Code ของคุณ

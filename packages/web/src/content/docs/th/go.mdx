...
Go ทำงานเหมือนกับผู้ให้บริการ (provider) รายอื่นๆ ใน Unlimit Code คุณสามารถสมัครสมาชิก OpenCode Go และรับ API key ของคุณ บริการนี้เป็น**ทางเลือกเพิ่มเติม** และคุณไม่จำเป็นต้องใช้มันเพื่อใช้งาน Unlimit Code
...
OpenCode Go ทำงานเหมือนกับผู้ให้บริการรายอื่นๆ ใน Unlimit Code
...
OpenCode Go ออกแบบมาสำหรับ [Unlimit Code](https://opencode.ai) และ coding agent อื่นๆ ที่สร้างคำขอประเภทเดียวกัน
...
นอกจาก Unlimit Code แล้ว ไคลเอนต์ต่อไปนี้ได้รับการตรวจสอบแล้วว่าทำงานกับ OpenCode Go ได้อย่างถูกต้อง

---
title: เซน
description: รายการโมเดลที่คัดสรรโดย Unlimit Code
---
...
Unlimit Code Zen คือรายการโมเดลที่ผ่านการทดสอบและยืนยันแล้วโดยทีม Unlimit Code

Zen ทำงานเหมือน provider อื่น ๆ ใน Unlimit Code คุณล็อกอินเข้า Unlimit Code Zen แล้วรับ
...
:::tip
เราได้ทดสอบโมเดลและ provider ที่คัดมาแล้วกลุ่มหนึ่งซึ่งทำงานได้ดีกับ Unlimit Code
:::
...
Unlimit Code Zen คือ AI gateway ที่ให้คุณเข้าถึงโมเดลเหล่านี้

---

## วิธีการทำงาน

Unlimit Code Zen ทำงานเหมือน provider อื่น ๆ ใน Unlimit Code

1. คุณลงชื่อเข้าใช้ **<a href={console}>Unlimit Code Zen</a>** เพิ่มรายละเอียดการเรียกเก็บเงิน แล้วคัดลอก API key ของคุณ
2. รันคำสั่ง `/connect` ใน TUI เลือก Unlimit Code Zen แล้ววาง API key ของคุณ
...
[model id](/docs/config/#models) ใน Unlimit Code config ของคุณใช้รูปแบบ `opencode/<model-id>` ตัวอย่างเช่น สำหรับ GPT 5.5 คุณจะใช้ `opencode/gpt-5.5` ใน config ของคุณ
...
ใช้ API key ของ Unlimit Code Zen กับ endpoint `https://opencode.ai/zen/v1/systemone` ตัวอย่างนี้ตรวจสอบว่า request ที่ส่งถึงฝ่าย support เป็นเรื่องเร่งด่วนหรือไม่:
...
คุณอาจสังเกตเห็น[โมเดลต้นทุนต่ำ](/docs/config/#models) เช่น Haiku, Nano หรือ Flash ในประวัติการใช้งานของคุณ Unlimit Code ใช้โมเดลเหล่านี้เพื่อสร้างชื่อเซสชัน
...
- MiMo-V2.6-Flash Free เปิดให้ใช้บน Unlimit Code ในช่วงเวลาจำกัด ทีมกำลังใช้ช่วงเวลานี้เพื่อเก็บ feedback และปรับปรุงโมเดล
- MiMo-V2.5 Free เปิดให้ใช้บน Unlimit Code ในช่วงเวลาจำกัด ทีมกำลังใช้ช่วงเวลานี้เพื่อเก็บ feedback และปรับปรุงโมเดล
- Ling 3.0 Flash Fin Free เปิดให้ใช้บน Unlimit Code ในช่วงเวลาจำกัด ทีมกำลังใช้ช่วงเวลานี้เพื่อเก็บ feedback และปรับปรุงโมเดล
- Nemotron 3 Ultra Free เปิดให้ใช้บน Unlimit Code ในช่วงเวลาจำกัด ทีมกำลังใช้ช่วงเวลานี้เพื่อเก็บ feedback และปรับปรุงโมเดล
- Nemotron 3.5 Lightning Free เปิดให้ใช้บน Unlimit Code ในช่วงเวลาจำกัด ทีมกำลังใช้ช่วงเวลานี้เพื่อเก็บ feedback และปรับปรุงโมเดล
- Big Pickle เป็น stealth model ที่ใช้งานฟรีบน Unlimit Code ในช่วงเวลาจำกัด ทีมกำลังใช้ช่วงเวลานี้เพื่อเก็บ feedback และปรับปรุงโมเดล
- Muse Spark 1.3 Contributor Free เปิดให้ใช้งานบน Unlimit Code ในช่วงเวลาจำกัด ทีมกำลังใช้ช่วงเวลานี้เพื่อรวบรวมความคิดเห็นและปรับปรุงโมเดล
- Jev 1.13 Free เปิดให้ใช้งานบน Unlimit Code ในช่วงเวลาจำกัด
...
เราสร้าง Unlimit Code Zen ขึ้นมาเพื่อ:
...
4. ทำให้เกิด **no lock-in** โดยให้คุณใช้มันร่วมกับ coding agent อื่น ๆ ได้ และยังเปิดให้คุณใช้ provider อื่น ๆ กับ Unlimit Code ได้เสมอ

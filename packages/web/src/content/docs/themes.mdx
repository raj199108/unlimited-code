...
With Unlimit Code you can select from one of several built-in themes, use a theme that adapts to your terminal theme, or define your own custom theme.

By default, Unlimit Code uses our own `opencode` theme.
...
Unlimit Code comes with several built-in themes.
...
- Want Unlimit Code to match their terminal's appearance
...
Unlimit Code supports a flexible JSON-based theme system that allows users to create and customize themes easily.

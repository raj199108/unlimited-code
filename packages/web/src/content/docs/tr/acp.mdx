...
Komut Paleti’nde `zed: acp registry` komutunu çalıştırarak Unlimit Code’u [Zed ACP Kayıt Defteri](https://zed.dev/docs/ai/external-agents#registry) üzerinden yükleyin.

Bunun yerine özel bir Unlimit Code çalıştırılabilir dosyası kullanmak için [Zed](https://zed.dev) yapılandırmanıza (`~/.config/zed/settings.json`) ekleyin:
...
Açmak için AI Chat agent seçicisindeki yeni 'Unlimit Code' ajanını kullanın.

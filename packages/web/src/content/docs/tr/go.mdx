...
Unlimit Code Go, popüler açık kodlama modellerine güvenilir erişim sağlayan düşük maliyetli **aylık 10$ aboneliğidir**.

Go, Unlimit Code'daki diğer sağlayıcılar gibi çalışır. Unlimit Code Go'ya abone olur ve API anahtarınızı alırsınız. Bu **tamamen isteğe bağlıdır** ve Unlimit Code'u kullanmak için bunu kullanmanıza gerek yoktur.
...
Unlimit Code Go, bu modellere **aylık 10$** karşılığında erişmenizi sağlar.

---

## Nasıl çalışır?

Unlimit Code Go, Unlimit Code'daki diğer sağlayıcılar gibi çalışır.

1. **<a href={console}>Unlimit Code Zen</a>**'e giriş yapın, Go'ya abone olun ve API anahtarınızı kopyalayın.
...
:::note
Her çalışma alanından yalnızca bir üye Unlimit Code Go'ya abone olabilir.
:::
...
Unlimit Code Go, [Unlimit Code](https://opencode.ai) ve benzer türde istekler üreten diğer kodlama aracıları için tasarlanmıştır.
...
Unlimit Code'un yanı sıra aşağıdaki istemcilerin Unlimit Code Go ile düzgün çalıştığı doğrulanmıştır.
Ancak gelecekte de çalışmaya devam edeceklerini garanti etmiyoruz.

| İstemci           | Oturum desteği                                                                                                                                                                                                                                               |
| ----------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| **Hermes**        | [PR #101864](https://github.com/NousResearch/hermes-agent/pull/101864) içeren derlemeler, ana ve yardımcı Unlimit Code isteklerinde başlığı gönderir. Düzeltme v0.21.0'dan sonra birleştirilmiştir; dolayısıyla v0.21.0 sürümü tek başına bu düzeltmeyi içermez. |
...
| **Pi**            | Güncel derlemeler Unlimit Code için oturum bilgilerini gönderir. Eski kurulumları güncelleyin.                                                                                                                                                                   |
...
| **Kilo Code CLI** | [PR #13752](https://github.com/Kilo-Org/kilocode/pull/13752) içeren derlemeler Unlimit Code oturum başlıklarını geri getirir. Bu düzeltme CLI'ı kapsar, VS Code uzantısını kapsamaz. Bkz. [issue #13723](https://github.com/Kilo-Org/kilocode/issues/13723).     |
...
Unlimit Code yapılandırmanızdaki [model id](/docs/config/#models) formatı `opencode-go/<model-id>` şeklindedir. Örneğin, Kimi K3 için yapılandırmanızda `opencode-go/kimi-k3` kullanmalısınız.
...
Unlimit Code Go'yu şu amaçlarla oluşturduk:
...
4. Unlimit Code ile diğer sağlayıcıları da kullanmanıza olanak tanıyarak **kilitlenme (vendor lock-in) olmamasını** sağlamak.

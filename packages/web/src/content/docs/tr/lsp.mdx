...
description: Unlimit Code, LSP sunucularınızla bütünleşir.
---

Unlimit Code, tanılamayı agent için geri bildirim olarak kullanmak üzere Language Server Protocol (LSP) sunucularıyla bütünleşebilir.

---

## Yerleşik

Unlimit Code, popüler diller için çeşitli yerleşik LSP sunucularıyla birlikte gelir:

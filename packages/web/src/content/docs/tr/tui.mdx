---
title: TUI
description: Unlimit Code terminal kullanıcı arayüzünü kullanma.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Unlimit Code, projelerinizde LLM ile çalışmak için etkileşimli bir terminal arayüzü (TUI) sunar.

Unlimit Code'u çalıştırdığınızda mevcut dizin için TUI başlar.
...
Unlimit Code TUI kullanırken `/` ve ardından komut adını yazarak hızlı eylemler çalıştırabilirsiniz. Örneğin:
...
Unlimit Code'a bir sağlayıcı ekler. Mevcut sağlayıcıları seçip API anahtarları eklemenizi sağlar.
...
Unlimit Code'dan çıkar. _Takma adlar_: `/quit`, `/q`
...
- `leader_timeout` - Unlimit Code'un leader key sonrasında ne kadar bekleyeceğini kontrol eder. Varsayılan değer `2000`.

...
OpenCode Zen, Unlimit Code ekibi tarafından test edilip doğrulanmış modellerin bir listesidir.

Zen, Unlimit Code'daki diğer sağlayıcılar gibi çalışır. OpenCode Zen'de oturum açıp API anahtarınızı alırsınız. Bu **tamamen isteğe bağlıdır** ve Unlimit Code kullanmak için buna ihtiyacınız yoktur.
...
OpenCode Zen, Unlimit Code'daki diğer sağlayıcılar gibi çalışır.

...
OpenCode Zen is a list of tested and verified models provided by the Unlimit Code team.

Zen works like any other provider in Unlimit Code. You login to OpenCode Zen and get
...
OpenCode Zen works like any other provider in Unlimit Code.

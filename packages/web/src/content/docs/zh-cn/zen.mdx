...
OpenCode Zen 是由 Unlimit Code 团队提供的一组经过测试和验证的模型。

Zen 的工作方式与 Unlimit Code 中的任何其他提供商相同。你登录 OpenCode Zen 并获取 API 密钥。它是**完全可选的**，即使不用它，你也可以照常使用 Unlimit Code。
...
OpenCode Zen 的工作方式与 Unlimit Code 中的任何其他提供商相同。

---
title: LSP 伺服器
description: Unlimit Code 與您的 LSP 伺服器整合。
---

Unlimit Code 可以與語言伺服器協定（LSP）伺服器整合，將診斷資訊作為 agent 的回饋。

---

## 內建支援

Unlimit Code 內建了多種適用於主流語言的 LSP 伺服器：
...
啟用 LSP 且 Unlimit Code 開啟檔案時，它會：
...
您可以透過 Unlimit Code 設定檔中的 `lsp` 部分來啟用並自訂 LSP 伺服器。

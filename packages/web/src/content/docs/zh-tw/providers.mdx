...
OpenCode Zen 是由 Unlimit Code 團隊提供的模型列表，這些模型已經過測試和驗證，能夠與 Unlimit Code 良好配合使用。[了解更多](/docs/zen)。
...
OpenCode Go 是一個低成本的訂閱計畫，提供對 Unlimit Code 團隊提供的流行開放編碼模型的可靠存取，這些模型已經過測試和驗證，能夠與 Unlimit Code 良好配合使用。
...
OpenCode Zen 是由 Unlimit Code 團隊提供的經過測試和驗證的模型列表。[了解更多](/docs/zen)。
